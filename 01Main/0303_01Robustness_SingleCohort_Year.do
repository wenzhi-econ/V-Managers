...
capture log close
log using "${Results}/logfile_20241209_TwoMainOutcomes_Robustness_SingleCohort_Year", replace text
...
generate cohortSingle = 1 if FT_Event_Time<=tm(2014m12) & FT_Event_Time>=tm(2014m1)
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/FT_Gains_AllEstimates_`var'_SingleCohort_Year.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/FT_Loss_AllEstimates_`var'_SingleCohort_Year.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/FT_GainsMinusLoss_AllEstimates_`var'_SingleCohort_Year.gph", replace
...
save "${Results}/FT_TwoMainOutcomes_SingleCohort_Year.dta", replace 
