...
tran_2yr_LtoL = calculate_transition_matrix(
    transition_dta.loc[(transition_dta["FT_LtoL"] == 1)], 2
)
tran_2yr_LtoH = calculate_transition_matrix(
    transition_dta.loc[(transition_dta["FT_LtoH"] == 1)], 2
)
tran_7yr_LtoL = calculate_transition_matrix(
    transition_dta.loc[(transition_dta["FT_LtoL"] == 1)], 7
)
tran_7yr_LtoH = calculate_transition_matrix(
    transition_dta.loc[(transition_dta["FT_LtoH"] == 1)], 7
)
