...
Output:
    "${Results}/logfile_20241209_TwoMainOutcomes_Robustness_NewHires2.txt"
...
capture log close
log using "${Results}/logfile_20241209_TwoMainOutcomes_Robustness_NewHires2", replace text
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
    ...
    reghdfe `var' ${four_events_dummies} if (FT_Mngr_both_WL2==1 & FT_Never_ChangeM==0 & TenureMin<2), absorb(IDlse YearMonth) vce(cluster IDlseMHR) 
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/FT_Gains_AllEstimates_`var'_NewHires2.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/FT_Loss_AllEstimates_`var'_NewHires2.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/FT_GainsMinusLoss_AllEstimates_`var'_NewHires2.gph", replace
...
save "${Results}/FT_TwoMainOutcomes_NewHires2.dta", replace 
