...
*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??
*?? step 2. codes updated using my second laptop
*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??

sysuse auto, clear 
summarize price, detail 
regress price foreign width, robust 
    //&? Suppose that in the last code block, I run the wrong regression.
    //&? The correct regression is listed here, which will be used as a pull request.

*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??
*?? step 3. after seeing the comments, I decide to add another regression
*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??

sysuse auto, clear 
regress price foreign length width, robust 
