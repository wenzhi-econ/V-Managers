...
The high-flyer measure used here is TB03.
...
Output:
    "${Results}/006EventStudiesWithTenureBasedMeasures/20250502log_TwoMainOutcomes_MeasureTB03.txt"
    "${Results}/006EventStudiesWithTenureBasedMeasures/TB03_TwoMainOutcomes_MeasureTB03.dta"
...
capture log close
log using "${Results}/006EventStudiesWithTenureBasedMeasures/20250502log_TwoMainOutcomes_MeasureTB03.txt", replace text
...
/* Naming patterns:
For normal "event * relative period" dummies, e.g. TB03_LtoL_X_Pre1 TB03_LtoH_X_Post0 TB03_HtoH_X_Post12
For binned dummies, e.g. TB03_LtoL_X_Pre_Before36 TB03_LtoH_X_Post_After84
*/
...
generate  TB03_Rel_Time = Rel_Time
summarize TB03_Rel_Time, detail // range: [-131, +130]
...
*!! TB03_LtoL
generate byte TB03_LtoL_X_Pre_Before`max_pre_period' = TB03_LtoL * (TB03_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte TB03_LtoL_X_Pre`time' = TB03_LtoL * (TB03_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte TB03_LtoL_X_Post`time' = TB03_LtoL * (TB03_Rel_Time == `time')
}
generate byte TB03_LtoL_X_Post_After`Lto_max_post_period' = TB03_LtoL * (TB03_Rel_Time > `Lto_max_post_period')

*!! TB03_LtoH
generate byte TB03_LtoH_X_Pre_Before`max_pre_period' = TB03_LtoH * (TB03_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte TB03_LtoH_X_Pre`time' = TB03_LtoH * (TB03_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte TB03_LtoH_X_Post`time' = TB03_LtoH * (TB03_Rel_Time == `time')
}
generate byte TB03_LtoH_X_Post_After`Lto_max_post_period' = TB03_LtoH * (TB03_Rel_Time > `Lto_max_post_period')

*!! TB03_HtoH 
generate byte TB03_HtoH_X_Pre_Before`max_pre_period' = TB03_HtoH * (TB03_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte TB03_HtoH_X_Pre`time' = TB03_HtoH * (TB03_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte TB03_HtoH_X_Post`time' = TB03_HtoH * (TB03_Rel_Time == `time')
}
generate byte TB03_HtoH_X_Post_After`Hto_max_post_period' = TB03_HtoH * (TB03_Rel_Time > `Hto_max_post_period')

*!! TB03_HtoL 
generate byte TB03_HtoL_X_Pre_Before`max_pre_period' = TB03_HtoL * (TB03_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte TB03_HtoL_X_Pre`time' = TB03_HtoL * (TB03_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte TB03_HtoL_X_Post`time' = TB03_HtoL * (TB03_Rel_Time == `time')
}
generate byte TB03_HtoL_X_Post_After`Hto_max_post_period' = TB03_HtoL * (TB03_Rel_Time > `Hto_max_post_period')
...
macro drop TB03_LtoL_X_Pre TB03_LtoL_X_Post TB03_LtoH_X_Pre TB03_LtoH_X_Post TB03_HtoH_X_Pre TB03_HtoH_X_Post TB03_HtoL_X_Pre TB03_HtoL_X_Post

foreach event in TB03_LtoL TB03_LtoH {
...
foreach event in TB03_HtoH TB03_HtoL {
    global `event'_X_Pre `event'_X_Pre_Before`max_pre_period'
    forvalues time = `max_pre_period'(-1)4 {
        global `event'_X_Pre ${`event'_X_Pre} `event'_X_Pre`time'
    }
...
global four_events_dummies ${TB03_LtoL_X_Pre} ${TB03_LtoL_X_Post} ${TB03_LtoH_X_Pre} ${TB03_LtoH_X_Post} ${TB03_HtoH_X_Pre} ${TB03_HtoH_X_Post} ${TB03_HtoL_X_Pre} ${TB03_HtoL_X_Post}

display "${four_events_dummies}"

    // TB03_LtoL_X_Pre_Before24 TB03_LtoL_X_Pre24 ... TB03_LtoL_X_Pre4 TB03_LtoL_X_Post0 TB03_LtoL_X_Post1 ... TB03_LtoL_X_Post84 TB03_LtoL_X_Pre_After84 
    // TB03_LtoH_X_Pre_Before24 TB03_LtoH_X_Pre24 ... TB03_LtoH_X_Pre4 TB03_LtoH_X_Post0 TB03_LtoH_X_Post1 ... TB03_LtoH_X_Post84 TB03_LtoH_X_Pre_After84 
    // TB03_HtoH_X_Pre_Before24 TB03_HtoH_X_Pre24 ... TB03_HtoH_X_Pre4 TB03_HtoH_X_Post0 TB03_HtoH_X_Post1 ... TB03_HtoH_X_Post60 TB03_HtoH_X_Pre_After60 
    // TB03_HtoL_X_Pre_Before24 TB03_HtoL_X_Pre24 ... TB03_HtoL_X_Pre4 TB03_HtoL_X_Post0 TB03_HtoL_X_Post1 ... TB03_HtoL_X_Post60 TB03_HtoL_X_Pre_After60 
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! pre-event joint p-value
    pretrend_LH_minus_LL, event_prefix(TB03) pre_window_len(24)
    ...
    *!! quarterly estimates
    LH_minus_LL, event_prefix(TB03) pre_window_len(24) post_window_len(84) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/006EventStudiesWithTenureBasedMeasures/TB03_Outcome${number}_`var'_Coef1_Gains.gph", replace
    ...
    *!! pre-event joint p-value
    pretrend_HL_minus_HH, event_prefix(TB03) pre_window_len(24)
    ...
    *!! quarterly estimates
    HL_minus_HH, event_prefix(TB03) pre_window_len(24) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/006EventStudiesWithTenureBasedMeasures/TB03_Outcome${number}_`var'_Coef2_Loss.gph", replace   
    ...
    *!! pre-event joint p-value
    pretrend_Double_Diff, event_prefix(TB03) pre_window_len(24)
    ...
    *!! post-event joint p-value
    postevent_Double_Diff, event_prefix(TB03) post_window_len(60)
    ...
    *!! quarterly estimates
    Double_Diff, event_prefix(TB03) pre_window_len(24) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/006EventStudiesWithTenureBasedMeasures/TB03_Outcome${number}_`var'_Coef3_GainsMinusLoss.gph", replace
...
save "${Results}/006EventStudiesWithTenureBasedMeasures/TB03_TwoMainOutcomes_MeasureTB03.dta", replace 
