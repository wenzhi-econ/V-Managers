...
The high-flyer measure used here is TB04.
...
Output:
    "${Results}/006EventStudiesWithTenureBasedMeasures/20250506log_TwoMainOutcomes_MeasureTB04_Pre24Post120.txt"
    "${Results}/006EventStudiesWithTenureBasedMeasures/TB04_TwoMainOutcomes_MeasureTB04.dta"
...
capture log close
log using "${Results}/006EventStudiesWithTenureBasedMeasures/20250506log_TwoMainOutcomes_MeasureTB04_Pre24Post120.txt", replace text
...
display "${four_events_dummies}"
    ...
    // TB04_LtoL_X_Pre_Before24 TB04_LtoL_X_Pre24 ... TB04_LtoL_X_Pre4 TB04_LtoL_X_Post0 TB04_LtoL_X_Post1 ... TB04_LtoL_X_Post120 TB04_LtoL_X_Pre_After120 
    // TB04_LtoH_X_Pre_Before24 TB04_LtoH_X_Pre24 ... TB04_LtoH_X_Pre4 TB04_LtoH_X_Post0 TB04_LtoH_X_Post1 ... TB04_LtoH_X_Post120 TB04_LtoH_X_Pre_After120 
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! pre-event joint p-value
    pretrend_LH_minus_LL, event_prefix(TB04) pre_window_len(24)
    ...
    *!! quarterly estimates
    LH_minus_LL, event_prefix(TB04) pre_window_len(24) post_window_len(120) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/006EventStudiesWithTenureBasedMeasures/TB04_Outcome${number}_`var'_Coef1_Gains_Pre24Post120.gph", replace
    ...
    *!! pre-event joint p-value
    pretrend_HL_minus_HH, event_prefix(TB04) pre_window_len(24)
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/006EventStudiesWithTenureBasedMeasures/TB04_Outcome${number}_`var'_Coef2_Loss_Pre24Post120.gph", replace   
    ...
    *!! pre-event joint p-value
    pretrend_Double_Diff, event_prefix(TB04) pre_window_len(24)
    ...
    *!! post-event joint p-value
    postevent_Double_Diff, event_prefix(TB04) post_window_len(60)
    ...
    *!! quarterly estimates
    Double_Diff, event_prefix(TB04) pre_window_len(24) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/006EventStudiesWithTenureBasedMeasures/TB04_Outcome${number}_`var'_Coef3_GainsMinusLoss_Pre24Post120.gph", replace
...
save "${Results}/006EventStudiesWithTenureBasedMeasures/TB04_TwoMainOutcomes_MeasureTB04_Pre24Post120.dta", replace 
