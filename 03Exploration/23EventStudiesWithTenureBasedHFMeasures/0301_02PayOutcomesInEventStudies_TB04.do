...
Output:
    "${Results}/20250506log_PayOutcomes_MeasureTB04.txt"
    "${Results}/TB04_PayOutcomes.dta"
...
capture log close
log using "${Results}/20250506log_PayOutcomes_MeasureTB04.txt", replace text
...
For binned dummies, e.g. TB04_LtoL_X_Pre_Before24 TB04_LtoH_X_Post_After84
*/
...
foreach var in LogPayBonus LogPay LogBonus {
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/TB04_Outcome${number}_`var'_Coef1_Gains.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/TB04_Outcome${number}_`var'_Coef2_Loss.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/TB04_Outcome${number}_`var'_Coef3_GainsMinusLoss.gph", replace
...
save "${Results}/TB04_PayOutcomes.dta", replace 
