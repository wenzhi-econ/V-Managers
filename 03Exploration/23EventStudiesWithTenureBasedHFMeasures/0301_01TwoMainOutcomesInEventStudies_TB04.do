...
Output:
    "${Results}/006EventStudiesWithTenureBasedMeasures/20250502log_TwoMainOutcomes_MeasureTB04.txt"
...
capture log close
log using "${Results}/006EventStudiesWithTenureBasedMeasures/20250502log_TwoMainOutcomes_MeasureTB04.txt", replace text
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/006EventStudiesWithTenureBasedMeasures/TB04_Outcome${number}_`var'_Coef1_Gains.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/006EventStudiesWithTenureBasedMeasures/TB04_Outcome${number}_`var'_Coef2_Loss.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/006EventStudiesWithTenureBasedMeasures/TB04_Outcome${number}_`var'_Coef3_GainsMinusLoss.gph", replace
...
save "${Results}/006EventStudiesWithTenureBasedMeasures/TB04_TwoMainOutcomes_MeasureTB04.dta", replace 
