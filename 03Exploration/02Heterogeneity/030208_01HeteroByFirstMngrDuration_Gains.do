...
Note:
    (1) The regression sample only consists of new hires in the sample.

Input:
    "${TempData}/04MainOutcomesInEventStudies.dta" <== created in 0104 do file.

Results:
    "${Results}/HeteroByFirstMngrDuration_Gains.tex"
...
esttab HighExpoPreMngr_CSGC HighExpoPreMngr_TSJVC HighExpoPreMngr_PWLC HighExpoPreMngr_Exit using "${Results}/HeteroByFirstMngrDuration_Gains.tex" ///
