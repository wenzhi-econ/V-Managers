/* 
This do file runs event study regressions on two main outcomes of interest (TransferSJVC ChangeSalaryGradeC) using the CA31 measure.

Input: 
    "${TempData}/031903FinalEventStudySample_SixHFMeasures.dta" <== created in 0104 do file

Output:
    "${Results}/20250410log_AgeBasedHF4_CA31_TwoMainOutcomes.txt"
    "${Results}/AgeBasedHF4_CA31_TwoMainOutcomes.dta"
...
capture log close
log using "${Results}/20250410log_AgeBasedHF4_CA31_TwoMainOutcomes", replace text
...
save "${Results}/AgeBasedHF4_CA31_TwoMainOutcomes.dta", replace 
