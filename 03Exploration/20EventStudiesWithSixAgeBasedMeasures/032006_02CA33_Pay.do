/* 
This do file runs event study regressions on three pay-relevant outcomes (LogPayBonus LogPay LogBonus) using the CA33 measure.

Input: 
    "${TempData}/031903FinalEventStudySample_SixHFMeasures.dta" <== created in 0104 do file

Output:
    "${Results}/20250410log_AgeBasedHF6_CA33_PayOutcomes.txt"
    "${Results}/AgeBasedHF6_CA33_PayOutcomes.dta"
...
capture log close
log using "${Results}/20250410log_AgeBasedHF6_CA33_PayOutcomes", replace text
...
foreach var in LogPayBonus LogPay LogBonus {
    ...
    *&& Quarter 28 estimate is the average of Month 82, Month 83, and Month 84 estimates
    ...
    xlincom ///
        (((CA33_LtoH_X_Post34 - CA33_LtoL_X_Post34) + (CA33_LtoH_X_Post35 - CA33_LtoL_X_Post35) + (CA33_LtoH_X_Post36 - CA33_LtoL_X_Post36))/3) ///
        (((CA33_LtoH_X_Post58 - CA33_LtoL_X_Post58) + (CA33_LtoH_X_Post59 - CA33_LtoL_X_Post59) + (CA33_LtoH_X_Post60 - CA33_LtoL_X_Post60))/3) ///
        (((CA33_LtoH_X_Post82 - CA33_LtoL_X_Post82) + (CA33_LtoH_X_Post83 - CA33_LtoL_X_Post83) + (CA33_LtoH_X_Post84 - CA33_LtoL_X_Post84))/3) ///
        , level(95) post
    ...
    graph save "${Results}/AgeBasedHF6_CA33_ThreeQuarterEstimates_`var'.gph", replace
}
...
save "${Results}/AgeBasedHF6_CA33_PayOutcomes.dta", replace 
