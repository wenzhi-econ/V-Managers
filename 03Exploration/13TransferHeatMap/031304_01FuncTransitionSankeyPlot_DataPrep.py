...
tran_1yr_LtoL_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoL"] == 1)], 1, "Ratio_1yr_LtoL_All")
tran_1yr_LtoH_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoH"] == 1)], 1, "Ratio_1yr_LtoH_All")
tran_2yr_LtoL_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoL"] == 1)], 2, "Ratio_2yr_LtoL_All")
tran_2yr_LtoH_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoH"] == 1)], 2, "Ratio_2yr_LtoH_All")
tran_3yr_LtoL_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoL"] == 1)], 3, "Ratio_3yr_LtoL_All")
tran_3yr_LtoH_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoH"] == 1)], 3, "Ratio_3yr_LtoH_All")
tran_4yr_LtoL_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoL"] == 1)], 4, "Ratio_4yr_LtoL_All")
tran_4yr_LtoH_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoH"] == 1)], 4, "Ratio_4yr_LtoH_All")
tran_5yr_LtoL_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoL"] == 1)], 5, "Ratio_5yr_LtoL_All")
tran_5yr_LtoH_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoH"] == 1)], 5, "Ratio_5yr_LtoH_All")
tran_6yr_LtoL_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoL"] == 1)], 6, "Ratio_6yr_LtoL_All")
tran_6yr_LtoH_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoH"] == 1)], 6, "Ratio_6yr_LtoH_All")
tran_7yr_LtoL_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoL"] == 1)], 7, "Ratio_7yr_LtoL_All")
tran_7yr_LtoH_all = tran_mat(transition_dta.loc[(transition_dta["FT_LtoH"] == 1)], 7, "Ratio_7yr_LtoH_All")
...
tran_ratio.to_stata(tempdata("temp_TranFunc_SankeyPlots.dta"), write_index=False)
