...
Output:
    "{EventStudyResults}/20250519log_Outcome1_ChangeSalaryGradeC_Type1_Pre24Post84.txt"
...
capture log close
log using "${EventStudyResults}/20250519log_Outcome1_ChangeSalaryGradeC_Type1_Pre24Post84.txt", replace text
