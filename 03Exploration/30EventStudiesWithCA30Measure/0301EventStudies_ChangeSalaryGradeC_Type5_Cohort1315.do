...
Output:
    "${EventStudyResults}/20250519log_Outcome1_ChangeSalaryGradeC_Type5_Cohort1315.txt"
...
capture log close
log using "${EventStudyResults}/20250519log_Outcome1_ChangeSalaryGradeC_Type5_Cohort1315.txt", replace text
