...
This do file establishes robustness in event study results, using a Poisson specification.
...
Output:
    "${EventStudyResults}/20250519log_Outcome2_TransferSJC_Type3_Poisson.txt"
    "${EventStudyResults}/Outcome2_TransferSJC_Type3_Poisson.dta"
...
capture log close
log using "${EventStudyResults}/20250519log_Outcome2_TransferSJC_Type3_Poisson.txt", replace text
...
foreach var in TransferSJC {
    ...
    if "`var'" == "TransferSJC" global ylabelsetup -1(0.1)1
    ...
    *!! quarterly estimates
    ...
    graph save "${EventStudyResults}/CA30_Outcome${number}_`var'_Coef1_Gains_Type3_Poisson.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${EventStudyResults}/CA30_Outcome${number}_`var'_Coef2_Loss_Type3_Poisson.gph", replace   
...
keep ///
    PTGain_* coeff_* quarter_* lb_* ub_* PTLoss_* ///
...
save "${EventStudyResults}/Outcome2_TransferSJC_Type3_Poisson.dta", replace 
