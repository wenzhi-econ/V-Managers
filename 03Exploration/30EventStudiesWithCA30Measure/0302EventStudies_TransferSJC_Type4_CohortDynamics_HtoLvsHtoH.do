...
Output:
    "${EventStudyResults}/20250519log_Outcome2_TransferSJC_Type4_CohortDynamics_HtoLvsHtoH.txt"
    "${EventStudyResults}/Outcome2_TransferSJC_Type4_CohortDynamics_HtoLvsHtoH.dta"
...
capture log close
log using "${EventStudyResults}/20250519log_Outcome2_TransferSJC_Type4_CohortDynamics_HtoLvsHtoH.txt", replace text
...
save "${EventStudyResults}/Outcome2_TransferSJC_Type4_CohortDynamics_HtoLvsHtoH.dta", replace 
