...
Output:
    "${EventStudyResults}/20250519log_Outcome3_TransferSJLC_Type4_CohortDynamics_LtoHvsLtoL.txt"
    "${EventStudyResults}/Outcome3_TransferSJLC_Type4_CohortDynamics_LtoHvsLtoL.dta"
...
capture log close
log using "${EventStudyResults}/20250519log_Outcome3_TransferSJLC_Type4_CohortDynamics_LtoHvsLtoL.txt", replace text
...
save "${EventStudyResults}/Outcome3_TransferSJLC_Type4_CohortDynamics_LtoHvsLtoL.dta", replace 
