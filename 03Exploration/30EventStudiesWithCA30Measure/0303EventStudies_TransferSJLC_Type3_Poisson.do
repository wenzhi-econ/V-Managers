...
Output:
    "${EventStudyResults}/20250519log_Outcome3_TransferSJLC_Type3_Poisson.txt"
    "${EventStudyResults}/Outcome3_TransferSJLC_Type3_Poisson.dta"
...
capture log close
log using "${EventStudyResults}/20250519log_Outcome3_TransferSJLC_Type3_Poisson.txt", replace text
...
save "${EventStudyResults}/Outcome3_TransferSJLC_Type3_Poisson.dta", replace 
