...
This do file establishes robustness in event study results, using new hires among event workers.
...
Output:
    "${EventStudyResults}/20250519log_Outcome2_TransferSJC_Type2_NewHires.txt"
    "${EventStudyResults}/Outcome2_TransferSJC_Type2_NewHires.dta"
...
capture log close
log using "${EventStudyResults}/20250519log_Outcome2_TransferSJC_Type2_NewHires.txt", replace text
...
*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??
*?? step 1. robustness variable: TenureMin
*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??
...
foreach var in TransferSJC {
    ...
    *!! quarterly estimates
    ...
    graph save "${EventStudyResults}/CA30_Outcome${number}_`var'_Coef1_Gains_Type2_NewHires.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${EventStudyResults}/CA30_Outcome${number}_`var'_Coef2_Loss_Type2_NewHires.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${EventStudyResults}/CA30_Outcome${number}_`var'_Coef3_GainsMinusLoss_Type2_NewHires.gph", replace
...
save "${EventStudyResults}/Outcome2_TransferSJC_Type2_NewHires.dta", replace 
