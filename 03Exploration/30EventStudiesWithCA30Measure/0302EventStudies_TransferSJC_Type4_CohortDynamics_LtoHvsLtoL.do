...
Output:
    "${EventStudyResults}/20250519log_Outcome2_TransferSJC_Type4_CohortDynamics_LtoHvsLtoL.txt"
    "${EventStudyResults}/Outcome2_TransferSJC_Type4_CohortDynamics_LtoHvsLtoL.dta"
...
capture log close
log using "${EventStudyResults}/20250519log_Outcome2_TransferSJC_Type4_CohortDynamics_LtoHvsLtoL.txt", replace text
...
foreach var in TransferSJC {
    ...
    *!! quarterly estimates
    ...
    twoway ///
        ...
        legend(off)
    graph save "${EventStudyResults}/CA30_Outcome${number}_`var'_Coef1_Gains_Type4_CohortDynamics.gph", replace
...
save "${EventStudyResults}/Outcome2_TransferSJC_Type4_CohortDynamics_LtoHvsLtoL.dta", replace 
