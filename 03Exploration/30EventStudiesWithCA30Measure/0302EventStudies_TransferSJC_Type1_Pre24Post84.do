...
Output:
    "{EventStudyResults}/20250519log_Outcome2_TransferSJC_Type1_Pre24Post84.txt"
    "${EventStudyResults}/Outcome2_TransferSJC_Type1_Pre24Post84.dta"
...
capture log close
log using "${EventStudyResults}/20250519log_Outcome2_TransferSJC_Type1_Pre24Post84.txt", replace text
...
save "${EventStudyResults}/Outcome2_TransferSJC_Type1_Pre24Post84.dta", replace 
