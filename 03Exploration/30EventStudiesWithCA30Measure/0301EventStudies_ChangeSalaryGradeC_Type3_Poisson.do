...
Output:
    "${EventStudyResults}/20250519log_Outcome1_ChangeSalaryGradeC_Type3_Poisson.txt"
...
capture log close
log using "${EventStudyResults}/20250519log_Outcome1_ChangeSalaryGradeC_Type3_Poisson.txt", replace text
