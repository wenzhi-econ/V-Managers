/* 
This do file decomposes the variable TransferSJC into three categories.
...
Output:
    "${Results}/005EventStudiesWithCA30/20250519log_Outcome2_TransferSJC_Typez_Decomp.txt"
    "${EventStudyResults}/Outcome2_TransferSJC_Typez_Decomp.dta"
...
capture log close
log using "${EventStudyResults}/20250519log_Outcome2_TransferSJC_Typez_Decomp.txt", replace text
...
graph save "${EventStudyResults}/CA30_Outcome2_TransferSJC_Decomp_Q8.gph", replace
...
graph save "${EventStudyResults}/CA30_Outcome2_TransferSJC_Decomp_Q28.gph", replace
...
save "${EventStudyResults}/Outcome2_TransferSJC_Typez_Decomp.dta", replace 
