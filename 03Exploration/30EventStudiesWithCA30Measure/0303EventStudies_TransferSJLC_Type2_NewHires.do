...
Output:
    "${EventStudyResults}/20250519log_Outcome3_TransferSJLC_Type2_NewHires.txt"
    "${EventStudyResults}/Outcome3_TransferSJLC_Type2_NewHires.dta"
...
capture log close
log using "${EventStudyResults}/20250519log_Outcome3_TransferSJLC_Type2_NewHires.txt", replace text
...
save "${EventStudyResults}/Outcome3_TransferSJLC_Type2_NewHires.dta", replace 
