...
Output:
    "{EventStudyResults}/20250521log_Outcome7_PromWLC_Typez_YearlyAggregation.txt"
    "${EventStudyResults}/Outcome7_PromWLC_Typez_YearlyAggregation.dta"
...
capture log close
log using "${EventStudyResults}/20250521log_Outcome7_PromWLC_Typez_YearlyAggregation.txt", replace text
