...
Output:
    "${EventStudyResults}/20250519log_EventStudies_ChangeSalaryGradeC_Type4_CohortDynamics_LtoHvsLtoL.txt"
    "${EventStudyResults}/Outcome1_ChangeSalaryGradeC_Type4_CohortDynamics_LtoHvsLtoL.dta"
...
capture log close
log using "${EventStudyResults}/20250519log_EventStudies_ChangeSalaryGradeC_Type4_CohortDynamics_LtoHvsLtoL.txt", replace text
...
save "${EventStudyResults}/Outcome1_ChangeSalaryGradeC_Type4_CohortDynamics_LtoHvsLtoL.dta", replace 
