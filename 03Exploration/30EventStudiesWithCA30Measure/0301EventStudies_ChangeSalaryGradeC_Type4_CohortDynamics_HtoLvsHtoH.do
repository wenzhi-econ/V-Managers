...
Output:
    "${EventStudyResults}/20250519log_Outcome1_ChangeSalaryGradeC_Type4_CohortDynamics_HtoLvsHtoH.txt"
...
capture log close
log using "${EventStudyResults}/20250519log_Outcome1_ChangeSalaryGradeC_Type4_CohortDynamics_HtoLvsHtoH.txt", replace text
