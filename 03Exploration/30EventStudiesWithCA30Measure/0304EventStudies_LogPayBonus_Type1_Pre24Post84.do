...
Output:
    "{EventStudyResults}/20250521log_Outcome4_LogPayBonus_Type1_Pre24Post84.txt"
...
capture log close
log using "${EventStudyResults}/20250521log_Outcome4_LogPayBonus_Type1_Pre24Post84.txt", replace text
...
foreach var in LogPayBonus {
    ...
    if "`var'" == "LogPayBonus" global number "4"
...
save "${EventStudyResults}/Outcome4_LogPayBonus_Type1_Pre24Post84.dta", replace 
