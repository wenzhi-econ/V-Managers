...
use "${TempData}/0104AnalysisSample_TenureRestriction0to2_WithHeteroIndicators.dta", clear 
...
global latex_file "${Results}/021FullResultsWithTenureRestriction0to2/CA30_HeterogeneityInFourMainOutcomes.tex"
