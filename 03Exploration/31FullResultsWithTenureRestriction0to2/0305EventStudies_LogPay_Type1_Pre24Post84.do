...
Output:
    "${EventStudyResults}/20250522log_Outcome5_LogPay_Type1_Pre24Post84.txt"
    "${EventStudyResults}/Outcome5_LogPay_Type1_Pre24Post84.dta"
...
capture log close
log using "${EventStudyResults}/20250522log_Outcome5_LogPay_Type1_Pre24Post84.txt", replace text
...
foreach var in LogPay {

    if "`var'" == "LogPay"      global title "Pay (logs)"
    if "`var'" == "LogPay"      global number "5"
...
save "${EventStudyResults}/Outcome5_LogPay_Type1_Pre24Post84.dta", replace 
