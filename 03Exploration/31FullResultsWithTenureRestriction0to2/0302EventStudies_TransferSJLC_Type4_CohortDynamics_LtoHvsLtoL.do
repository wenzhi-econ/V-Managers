...
Output:
    "${EventStudyResults}/20250522log_Outcome2_TransferSJLC_Type4_CohortDynamics_LtoHvsLtoL.txt"
    "${EventStudyResults}/Outcome2_TransferSJLC_Type4_CohortDynamics_LtoHvsLtoL.dta"
...
capture log close
log using "${EventStudyResults}/20250522log_Outcome2_TransferSJLC_Type4_CohortDynamics_LtoHvsLtoL.txt", replace text
...
save "${EventStudyResults}/Outcome2_TransferSJLC_Type4_CohortDynamics_LtoHvsLtoL.dta", replace 
