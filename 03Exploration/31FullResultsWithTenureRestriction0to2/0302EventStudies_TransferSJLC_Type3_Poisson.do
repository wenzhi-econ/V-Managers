...
Output:
    "${EventStudyResults}/20250522log_Outcome2_TransferSJLC_Type3_Poisson.txt"
    "${EventStudyResults}/Outcome2_TransferSJLC_Type3_Poisson.dta"
...
capture log close
log using "${EventStudyResults}/20250522log_Outcome2_TransferSJLC_Type3_Poisson.txt", replace text
...
foreach var in TransferSJLC {
    ...
    if "`var'" == "TransferSJLC" global ylabelsetup -1(0.1)1
...
save "${EventStudyResults}/Outcome2_TransferSJLC_Type3_Poisson.dta", replace 
