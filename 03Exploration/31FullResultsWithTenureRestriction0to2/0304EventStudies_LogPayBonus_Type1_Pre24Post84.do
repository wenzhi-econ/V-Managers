...
Output:
    "${EventStudyResults}/20250522log_Outcome4_LogPayBonus_Type1_Pre24Post84.txt"
...
capture log close
log using "${EventStudyResults}/20250522log_Outcome4_LogPayBonus_Type1_Pre24Post84.txt", replace text
