...
Special notes:
    (1) The resulting dataset contains only those employees whose tenure at the event time is in the range of [0,2].
    (2) Median-based heterogeneity indicators are calculated based on the above tenure-restricted sample.
...
Output:
    ...
    "${TempData}/0104AnalysisSample_TenureRestriction0to2_WithHeteroIndicators.dta"   <== main output dataset
...
sort IDlse YearMonth
save "${TempData}/0104AnalysisSample_TenureRestriction0to2_WithHeteroIndicators.dta", replace 