...
cdfplot WorkDuration, by(Treatment) /// 
...
graph export "${Results}/PostEventMngrDuration_EventLevel_CDF.png", replace as(png)
...
histogram WorkDuration if FT_LtoL==1 ///
    , width(1) fraction ///
...
graph export "${Results}/PostEventMngrDuration_EventLevel_Histogram_LtoL.png", replace as(png)

histogram WorkDuration if FT_LtoH==1 ///
    , width(1) fraction ///
    xtitle("Duration at work after event") xlabel(0(25)150, grid gstyle(dot)) ///
    ytitle("Fraction") ylabel(0(0.005)0.065, grid gstyle(dot)) ///
    title("Managers' duration at work after event, LtoH")
graph export "${Results}/PostEventMngrDuration_EventLevel_Histogram_LtoH.png", replace as(png)

histogram WorkDuration if FT_HtoH==1 ///
    , width(1) fraction ///
    xtitle("Duration at work after event") xlabel(0(25)150, grid gstyle(dot)) ///
    ytitle("Fraction") ylabel(0(0.005)0.065, grid gstyle(dot)) ///
    title("Managers' duration at work after event, HtoH") 
graph export "${Results}/PostEventMngrDuration_EventLevel_Histogram_HtoH.png", replace as(png)

histogram WorkDuration if FT_HtoL==1 ///
    , width(1) fraction ///
    xtitle("Duration at work after event") xlabel(0(25)150, grid gstyle(dot)) ///
    ytitle("Fraction") ylabel(0(0.005)0.065, grid gstyle(dot)) ///
    title("Managers' duration at work after event, HtoL") 
graph export "${Results}/PostEventMngrDuration_EventLevel_Histogram_HtoL.png", replace as(png)

histogram WorkDuration ///
    , width(1) fraction ///
    xtitle("Duration at work after event") xlabel(0(25)150, grid gstyle(dot)) ///
    ytitle("Fraction") ylabel(0(0.005)0.065, grid gstyle(dot)) ///
    title("Managers' duration at work after event, all managers") 
graph export "${Results}/PostEventMngrDuration_EventLevel_Histogram_All.png", replace as(png)


summarize WorkDuration, detail 
/* 
. summarize WorkDuration, detail 
...
-------------------------------------------------------------
 ...
 5%            2              1
10%            3              1       Obs              29,610
25%            8              1       Sum of wgt.      29,610

50%           17                      Mean           22.06646
                        Largest       Std. dev.      19.63848
75%           31            128
90%           47            128       Variance         385.67
95%           60            128       Skewness        1.64788
99%           94            128       Kurtosis       6.489944

 */

summarize WorkDuration if FT_LtoL==1, detail
/* . summarize WorkDuration if FT_LtoL==1, detail
...
-------------------------------------------------------------
 ...
 5%            2              1
10%            3              1       Obs              20,853
25%            8              1       Sum of wgt.      20,853

50%           19                      Mean           24.01774
                        Largest       Std. dev.      21.10009
75%           34            128
90%           52            128       Variance       445.2137
95%           66            128       Skewness       1.540307
99%           99            128       Kurtosis         5.8019
 */
summarize WorkDuration if FT_LtoH==1, detail
/* 
. summarize WorkDuration if FT_LtoH==1, detail
...
-------------------------------------------------------------
 ...
 5%            2              1
10%            3              1       Obs               4,148
25%            6              1       Sum of wgt.       4,148

50%           14                      Mean           17.01953
                        Largest       Std. dev.       13.7484
75%           25             82
90%           37             82       Variance       189.0184
95%           43             87       Skewness       1.199735
99%           61             89       Kurtosis       4.561825
 */
summarize WorkDuration if FT_HtoH==1, detail
/* 
. summarize WorkDuration if FT_HtoH==1, detail
...
-------------------------------------------------------------
 ...
 5%            1              1
10%            2              1       Obs               1,753
25%            6              1       Sum of wgt.       1,753

50%           14                      Mean           16.15516
                        Largest       Std. dev.      12.35505
75%           24             61
90%           33             66       Variance       152.6471
95%           43             67       Skewness       .9518806
99%           49             74       Kurtosis       3.639688
 */
summarize WorkDuration if FT_HtoL==1, detail
/* 
. summarize WorkDuration if FT_HtoL==1, detail
...
-------------------------------------------------------------
 ...
 5%            2              1
10%            2              1       Obs               2,856
25%            6              1       Sum of wgt.       2,856

50%           14                      Mean           18.77766
                        Largest       Std. dev.      16.81474
75%           27             99
90%           39             99       Variance       282.7355
95%           51            116       Skewness       1.682214
99%           76            117       Kurtosis       7.069115
 */
...
graph export "${Results}/PostEventMngrDuration_EventLevel.png", replace as(png)
