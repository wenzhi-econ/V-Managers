...
save "${TempData}/temp_EventMngrStatisticsHFVsNHF_withMngrFE.dta", replace 

*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??
*?? step 3: produce the summary table 
*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??

use "${TempData}/temp_EventMngrStatisticsHFVsNHF_withMngrFE.dta", clear 
...
preserve 
    ...
    *!! s-3-1-2: average over all post periods 
    ...
    balancetable EarlyAge PayGrowth WLAgg3 VPA LineManagerMean ///
        using "${Results}/MngrHFvsNHFStatistics_withMngrFE.tex", ///
