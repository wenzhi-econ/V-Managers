...
*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
*-? s-1-0. generate a list of event managers 
*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
...
merge m:1 IDlse using "${TempData}/temp_EventMngrIDList.dta", keep(match) nogenerate 
    //&? keep only those matched workers 
    //&? who are also in the "${TempData}/temp_EventMngrIDList.dta" dataset 
    //&? i.e., managers who are also in event studies, as pre- or post-event managers
...
label variable LowIncome      "Working in low or lower middle countries"
label variable UpperMidIncome "Working in upper middle countries"
...
save "${TempData}/temp_EventMngrStatisticsHFVsNHF_EventMngrSample.dta", replace 

*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??
*?? step 3: produce the summary table 
*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??

use "${TempData}/temp_EventMngrStatisticsHFVsNHF_EventMngrSample.dta", clear 
...
preserve 
    ...
    *!! s-3-1-2: average over all post periods 
    ...
    balancetable EarlyAge PayGrowth WLAgg3 VPA LineManagerMean ///
        using "${Results}/MngrHFvsNHFStatistics_EventMngrSample.tex", ///
...
label variable MFEBayesLogPay_Med  "Manager FE, above median"
label variable MFEBayesLogPay_p75  "Manager FE, above p75"

capture drop occurrence
sort IDlse YearMonth
bysort IDlse: generate occurrence = _n 

balancetable EarlyAge MFEBayesLogPay MFEBayesLogPay_Med MFEBayesLogPay_p75 if occurrence==1 ///
    using "${Results}/MngrHFvsNHFStatistics_EventMngrSample.tex", ///
...
balancetable EarlyAge Female MBA Econ Sci Hum Other func_cd func_m func_sc func_rd func_fi func_o MidCareerHire LowIncome UpperMidIncome if occurrence==1 ///
    using "${Results}/MngrHFvsNHFStatistics_EventMngrSample.tex", ///
    pval varla vce(cluster IDlse)  ///
    noli nonum append ///
    prehead(" ") ///
