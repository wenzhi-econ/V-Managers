...
Special notes:
    (1) The resulting dataset contains only those employees whose tenure at the event time is in the range of [0,3].
...
sort IDlse YearMonth
save "${TempData}/0104AnalysisSample_TenureRestriction0to3_WithHeteroIndicators.dta", replace 