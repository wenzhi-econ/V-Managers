...
Output:
    "${EventStudyResults}/20250522log_Outcome3_ONETDistC_Type1_Pre24Post84.txt"
    "${EventStudyResults}/CA30_ONETDistC.dta"
...
capture log close
log using "${EventStudyResults}/20250522log_Outcome3_ONETDistC_Type1_Pre24Post84.txt", replace text
...
foreach var in ONETDistC {
    ...
    if "`var'" == "ONETDistC" global number "3"
    ...
    *!! quarterly estimates
    ...
    twoway ///
        ...
        ylabel(-0.04(0.01)0.04, grid gstyle(dot) labsize(medsmall)) ///
...
save "${EventStudyResults}/Outcome3_ONETDistC_Type1_Pre24Post84.dta", replace 
