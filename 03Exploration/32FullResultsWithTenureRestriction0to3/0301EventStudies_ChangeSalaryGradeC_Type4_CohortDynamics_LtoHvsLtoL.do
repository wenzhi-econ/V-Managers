...
Output:
    "${EventStudyResults}/20250522log_EventStudies_ChangeSalaryGradeC_Type4_CohortDynamics_LtoHvsLtoL.txt"
...
capture log close
log using "${EventStudyResults}/20250522log_EventStudies_ChangeSalaryGradeC_Type4_CohortDynamics_LtoHvsLtoL.txt", replace text
