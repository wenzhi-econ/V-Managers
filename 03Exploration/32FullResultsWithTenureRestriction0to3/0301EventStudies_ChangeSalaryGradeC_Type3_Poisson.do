...
Output:
    "${EventStudyResults}/20250522log_Outcome1_ChangeSalaryGradeC_Type3_Poisson.txt"
    "${EventStudyResults}/Outcome1_ChangeSalaryGradeC_Type3_Poisson.dta"
...
capture log close
log using "${EventStudyResults}/20250522log_Outcome1_ChangeSalaryGradeC_Type3_Poisson.txt", replace text
...
foreach var in ChangeSalaryGradeC {
    ...
    if "`var'" == "ChangeSalaryGradeC" global ylabelsetup -1(0.1)1
...
save "${EventStudyResults}/Outcome1_ChangeSalaryGradeC_Type3_Poisson.dta", replace 
