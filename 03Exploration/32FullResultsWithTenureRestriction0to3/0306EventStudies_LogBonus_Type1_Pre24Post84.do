/* 
This do file runs event study regressions on outcome: LogPayBonus.
...
Output:
    "${EventStudyResults}/20250522log_Outcome6_LogBonus_Type1_Pre24Post84.txt"
    "${EventStudyResults}/Outcome6_LogBonus_Type1_Pre24Post84.dta"
...
capture log close
log using "${EventStudyResults}/20250522log_Outcome6_LogBonus_Type1_Pre24Post84.txt", replace text
...
foreach var in LogBonus {

    if "`var'" == "LogBonus"      global title "Bonus (logs)"
    if "`var'" == "LogBonus"      global number "6"
    ...
    *!! quarterly estimates
    ...
    twoway ///
        ...
        ylabel(-2(0.2)2, grid gstyle(dot) labsize(medsmall)) yscale(range(-0.3 0.3)) ///
...
save "${EventStudyResults}/Outcome6_LogBonus_Type1_Pre24Post84.dta", replace 
