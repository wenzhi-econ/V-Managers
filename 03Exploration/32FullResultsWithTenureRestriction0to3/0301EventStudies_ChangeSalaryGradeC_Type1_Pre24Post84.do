...
Output:
    "{EventStudyResults}/20250522log_Outcome1_ChangeSalaryGradeC_Type1_Pre24Post84.txt"
    "${EventStudyResults}/Outcome1_ChangeSalaryGradeC_Type1_Pre24Post84.dta"
...
capture log close
log using "${EventStudyResults}/20250522log_Outcome1_ChangeSalaryGradeC_Type1_Pre24Post84.txt", replace text
...
save "${EventStudyResults}/Outcome1_ChangeSalaryGradeC_Type1_Pre24Post84.dta", replace 
