...
Output:
    "${EventStudyResults}/20250522log_Outcome2_TransferSJLC_Type5_Cohort1315.txt"
    "${EventStudyResults}/Outcome2_TransferSJLC_Type5_Cohort1315.dta"
...
capture log close
log using "${EventStudyResults}/20250522log_Outcome2_TransferSJLC_Type5_Cohort1315.txt", replace text
...
foreach var in TransferSJLC {
    ...
    if "`var'" == "TransferSJLC" global number "2"
...
save "${EventStudyResults}/Outcome2_TransferSJLC_Type5_Cohort1315.dta", replace 
