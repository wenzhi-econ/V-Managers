/* 
This do file runs event study regressions on the probability of doing at least one lateral move after the event.
...
Output:
    "${Results}/20250522log_Outcome3_SJLAtLeast1_Type1_OnlyPost84.txt"
    "${Results}/CA30_ProbLateralTransfer.dta"
...
capture log close
log using "${EventStudyResults}/20250522log_Outcome3_SJLAtLeast1_Type1_OnlyPost84.txt", replace text
...
*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
*-? s-0-3. Event_Post variable 
*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?

generate Event_Post = (CA30_Rel_Time>=0) if CA30_Rel_Time!=.

*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??
*?? step 1. regressions on the probabilities of making exact number of lateral moves
*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??

foreach var in SJLAtLeast1 {

    if "`var'" == "SJLAtLeast1" global title "Probability of at least 1 lateral move"
    if "`var'" == "SJLAtLeast1" global number "3"

    *-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
    *-? step 1. Main Regression
    *-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?

    reghdfe `var' ${four_events_dummies} if Event_Post==1, absorb(IDlse YearMonth) vce(cluster IDlseMHR) 
    ...
    *!! quarterly estimates
    ...
    twoway ///
        ...
        ylabel(-0.1(0.01)0.1, grid gstyle(dot)) ///
        xtitle(Quarters since manager change) title("${title}", span pos(12)) ///
        legend(off)
    graph save "${EventStudyResults}/CA30_Outcome${number}_`var'_Coef1_Gains_Type1_Pre24Post84.gph", replace
    ...
    *!! quarterly estimates
    ...
    twoway ///
        ...
        xtitle(Quarters since manager change) title("${title}", span pos(12)) ///
        legend(off)
    graph save "${EventStudyResults}/CA30_Outcome${number}_`var'_Coef2_Loss_Type1_Pre24Post84.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${EventStudyResults}/CA30_Outcome${number}_`var'_Coef3_GainsMinusLoss_Type1_Pre24Post84.gph", replace
}
...
save "${EventStudyResults}/Outcome3_SJLAtLeast1_Type1_Pre24Post84.dta", replace 
