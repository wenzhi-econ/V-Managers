...
The high-flyer measure used here is SJ33.
...
Output:
    "${Results}/007EventStudiesWithMngrFEBasedMeasures/20250513log_TwoMainOutcomes_MeasureSJ33.txt"
    "${Results}/007EventStudiesWithMngrFEBasedMeasures/SJ33_TwoMainOutcomes.dta"
...
capture log close
log using "${Results}/007EventStudiesWithMngrFEBasedMeasures/20250513log_TwoMainOutcomes_MeasureSJ33.txt", replace text
...
keep if SJ33_LtoL!=.
    //impt: keep only those event workers whose event groups can be classified under SJ33 measure.
...
/* Naming patterns:
For normal "event * relative period" dummies, e.g. SJ33_LtoL_X_Pre1 SJ33_LtoH_X_Post0 SJ33_HtoH_X_Post12
For binned dummies, e.g. SJ33_LtoL_X_Pre_Before36 SJ33_LtoH_X_Post_After84
*/
...
generate  SJ33_Rel_Time = Rel_Time
summarize SJ33_Rel_Time, detail // range: [-131, +130]
...
*!! SJ33_LtoL
generate byte SJ33_LtoL_X_Pre_Before`max_pre_period' = SJ33_LtoL * (SJ33_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte SJ33_LtoL_X_Pre`time' = SJ33_LtoL * (SJ33_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte SJ33_LtoL_X_Post`time' = SJ33_LtoL * (SJ33_Rel_Time == `time')
}
generate byte SJ33_LtoL_X_Post_After`Lto_max_post_period' = SJ33_LtoL * (SJ33_Rel_Time > `Lto_max_post_period')

*!! SJ33_LtoH
generate byte SJ33_LtoH_X_Pre_Before`max_pre_period' = SJ33_LtoH * (SJ33_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte SJ33_LtoH_X_Pre`time' = SJ33_LtoH * (SJ33_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte SJ33_LtoH_X_Post`time' = SJ33_LtoH * (SJ33_Rel_Time == `time')
}
generate byte SJ33_LtoH_X_Post_After`Lto_max_post_period' = SJ33_LtoH * (SJ33_Rel_Time > `Lto_max_post_period')

*!! SJ33_HtoH 
generate byte SJ33_HtoH_X_Pre_Before`max_pre_period' = SJ33_HtoH * (SJ33_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte SJ33_HtoH_X_Pre`time' = SJ33_HtoH * (SJ33_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte SJ33_HtoH_X_Post`time' = SJ33_HtoH * (SJ33_Rel_Time == `time')
}
generate byte SJ33_HtoH_X_Post_After`Hto_max_post_period' = SJ33_HtoH * (SJ33_Rel_Time > `Hto_max_post_period')

*!! SJ33_HtoL 
generate byte SJ33_HtoL_X_Pre_Before`max_pre_period' = SJ33_HtoL * (SJ33_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte SJ33_HtoL_X_Pre`time' = SJ33_HtoL * (SJ33_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte SJ33_HtoL_X_Post`time' = SJ33_HtoL * (SJ33_Rel_Time == `time')
}
generate byte SJ33_HtoL_X_Post_After`Hto_max_post_period' = SJ33_HtoL * (SJ33_Rel_Time > `Hto_max_post_period')
...
macro drop SJ33_LtoL_X_Pre SJ33_LtoL_X_Post SJ33_LtoH_X_Pre SJ33_LtoH_X_Post SJ33_HtoH_X_Pre SJ33_HtoH_X_Post SJ33_HtoL_X_Pre SJ33_HtoL_X_Post

foreach event in SJ33_LtoL SJ33_LtoH {
...
foreach event in SJ33_HtoH SJ33_HtoL {
    global `event'_X_Pre `event'_X_Pre_Before`max_pre_period'
    forvalues time = `max_pre_period'(-1)4 {
        global `event'_X_Pre ${`event'_X_Pre} `event'_X_Pre`time'
    }
...
global four_events_dummies ${SJ33_LtoL_X_Pre} ${SJ33_LtoL_X_Post} ${SJ33_LtoH_X_Pre} ${SJ33_LtoH_X_Post} ${SJ33_HtoH_X_Pre} ${SJ33_HtoH_X_Post} ${SJ33_HtoL_X_Pre} ${SJ33_HtoL_X_Post}

display "${four_events_dummies}"

    // SJ33_LtoL_X_Pre_Before24 SJ33_LtoL_X_Pre24 ... SJ33_LtoL_X_Pre4 SJ33_LtoL_X_Post0 SJ33_LtoL_X_Post1 ... SJ33_LtoL_X_Post84 SJ33_LtoL_X_Pre_After84 
    // SJ33_LtoH_X_Pre_Before24 SJ33_LtoH_X_Pre24 ... SJ33_LtoH_X_Pre4 SJ33_LtoH_X_Post0 SJ33_LtoH_X_Post1 ... SJ33_LtoH_X_Post84 SJ33_LtoH_X_Pre_After84 
    // SJ33_HtoH_X_Pre_Before24 SJ33_HtoH_X_Pre24 ... SJ33_HtoH_X_Pre4 SJ33_HtoH_X_Post0 SJ33_HtoH_X_Post1 ... SJ33_HtoH_X_Post60 SJ33_HtoH_X_Pre_After60 
    // SJ33_HtoL_X_Pre_Before24 SJ33_HtoL_X_Pre24 ... SJ33_HtoL_X_Pre4 SJ33_HtoL_X_Post0 SJ33_HtoL_X_Post1 ... SJ33_HtoL_X_Post60 SJ33_HtoL_X_Pre_After60 
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! pre-event joint p-value
    pretrend_LH_minus_LL, event_prefix(SJ33) pre_window_len(24)
    ...
    *!! quarterly estimates
    LH_minus_LL, event_prefix(SJ33) pre_window_len(24) post_window_len(84) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/007EventStudiesWithMngrFEBasedMeasures/SJ33_Outcome${number}_`var'_Coef1_Gains.gph", replace
    ...
    *!! pre-event joint p-value
    pretrend_HL_minus_HH, event_prefix(SJ33) pre_window_len(24)
    ...
    *!! quarterly estimates
    HL_minus_HH, event_prefix(SJ33) pre_window_len(24) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/007EventStudiesWithMngrFEBasedMeasures/SJ33_Outcome${number}_`var'_Coef2_Loss.gph", replace   
    ...
    *!! pre-event joint p-value
    pretrend_Double_Diff, event_prefix(SJ33) pre_window_len(24)
    ...
    *!! post-event joint p-value
    postevent_Double_Diff, event_prefix(SJ33) post_window_len(60)
    ...
    *!! quarterly estimates
    Double_Diff, event_prefix(SJ33) pre_window_len(24) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/007EventStudiesWithMngrFEBasedMeasures/SJ33_Outcome${number}_`var'_Coef3_GainsMinusLoss.gph", replace
...
save "${Results}/007EventStudiesWithMngrFEBasedMeasures/SJ33_TwoMainOutcomes.dta", replace 
