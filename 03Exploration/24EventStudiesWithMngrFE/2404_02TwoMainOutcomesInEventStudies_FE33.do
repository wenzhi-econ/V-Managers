...
The high-flyer measure used here is FE33.
...
Output:
    "${Results}/007EventStudiesWithMngrFEBasedMeasures/20250513log_TwoMainOutcomes_MeasureFE33.txt"
    "${Results}/007EventStudiesWithMngrFEBasedMeasures/FE33_TwoMainOutcomes.dta"
...
capture log close
log using "${Results}/007EventStudiesWithMngrFEBasedMeasures/20250513log_TwoMainOutcomes_MeasureFE33.txt", replace text
...
keep if FE33_LtoL!=.
    //impt: keep only those event workers whose event groups can be classified under FE33 measure.
...
/* Naming patterns:
For normal "event * relative period" dummies, e.g. FE33_LtoL_X_Pre1 FE33_LtoH_X_Post0 FE33_HtoH_X_Post12
For binned dummies, e.g. FE33_LtoL_X_Pre_Before36 FE33_LtoH_X_Post_After84
*/
...
generate  FE33_Rel_Time = Rel_Time
summarize FE33_Rel_Time, detail // range: [-131, +130]
...
*!! FE33_LtoL
generate byte FE33_LtoL_X_Pre_Before`max_pre_period' = FE33_LtoL * (FE33_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte FE33_LtoL_X_Pre`time' = FE33_LtoL * (FE33_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte FE33_LtoL_X_Post`time' = FE33_LtoL * (FE33_Rel_Time == `time')
}
generate byte FE33_LtoL_X_Post_After`Lto_max_post_period' = FE33_LtoL * (FE33_Rel_Time > `Lto_max_post_period')

*!! FE33_LtoH
generate byte FE33_LtoH_X_Pre_Before`max_pre_period' = FE33_LtoH * (FE33_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte FE33_LtoH_X_Pre`time' = FE33_LtoH * (FE33_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte FE33_LtoH_X_Post`time' = FE33_LtoH * (FE33_Rel_Time == `time')
}
generate byte FE33_LtoH_X_Post_After`Lto_max_post_period' = FE33_LtoH * (FE33_Rel_Time > `Lto_max_post_period')

*!! FE33_HtoH 
generate byte FE33_HtoH_X_Pre_Before`max_pre_period' = FE33_HtoH * (FE33_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte FE33_HtoH_X_Pre`time' = FE33_HtoH * (FE33_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte FE33_HtoH_X_Post`time' = FE33_HtoH * (FE33_Rel_Time == `time')
}
generate byte FE33_HtoH_X_Post_After`Hto_max_post_period' = FE33_HtoH * (FE33_Rel_Time > `Hto_max_post_period')

*!! FE33_HtoL 
generate byte FE33_HtoL_X_Pre_Before`max_pre_period' = FE33_HtoL * (FE33_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte FE33_HtoL_X_Pre`time' = FE33_HtoL * (FE33_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte FE33_HtoL_X_Post`time' = FE33_HtoL * (FE33_Rel_Time == `time')
}
generate byte FE33_HtoL_X_Post_After`Hto_max_post_period' = FE33_HtoL * (FE33_Rel_Time > `Hto_max_post_period')
...
macro drop FE33_LtoL_X_Pre FE33_LtoL_X_Post FE33_LtoH_X_Pre FE33_LtoH_X_Post FE33_HtoH_X_Pre FE33_HtoH_X_Post FE33_HtoL_X_Pre FE33_HtoL_X_Post

foreach event in FE33_LtoL FE33_LtoH {
...
foreach event in FE33_HtoH FE33_HtoL {
    global `event'_X_Pre `event'_X_Pre_Before`max_pre_period'
    forvalues time = `max_pre_period'(-1)4 {
        global `event'_X_Pre ${`event'_X_Pre} `event'_X_Pre`time'
    }
...
global four_events_dummies ${FE33_LtoL_X_Pre} ${FE33_LtoL_X_Post} ${FE33_LtoH_X_Pre} ${FE33_LtoH_X_Post} ${FE33_HtoH_X_Pre} ${FE33_HtoH_X_Post} ${FE33_HtoL_X_Pre} ${FE33_HtoL_X_Post}

display "${four_events_dummies}"

    // FE33_LtoL_X_Pre_Before24 FE33_LtoL_X_Pre24 ... FE33_LtoL_X_Pre4 FE33_LtoL_X_Post0 FE33_LtoL_X_Post1 ... FE33_LtoL_X_Post84 FE33_LtoL_X_Pre_After84 
    // FE33_LtoH_X_Pre_Before24 FE33_LtoH_X_Pre24 ... FE33_LtoH_X_Pre4 FE33_LtoH_X_Post0 FE33_LtoH_X_Post1 ... FE33_LtoH_X_Post84 FE33_LtoH_X_Pre_After84 
    // FE33_HtoH_X_Pre_Before24 FE33_HtoH_X_Pre24 ... FE33_HtoH_X_Pre4 FE33_HtoH_X_Post0 FE33_HtoH_X_Post1 ... FE33_HtoH_X_Post60 FE33_HtoH_X_Pre_After60 
    // FE33_HtoL_X_Pre_Before24 FE33_HtoL_X_Pre24 ... FE33_HtoL_X_Pre4 FE33_HtoL_X_Post0 FE33_HtoL_X_Post1 ... FE33_HtoL_X_Post60 FE33_HtoL_X_Pre_After60 
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! pre-event joint p-value
    pretrend_LH_minus_LL, event_prefix(FE33) pre_window_len(24)
    ...
    *!! quarterly estimates
    LH_minus_LL, event_prefix(FE33) pre_window_len(24) post_window_len(84) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/007EventStudiesWithMngrFEBasedMeasures/FE33_Outcome${number}_`var'_Coef1_Gains.gph", replace
    ...
    *!! pre-event joint p-value
    pretrend_HL_minus_HH, event_prefix(FE33) pre_window_len(24)
    ...
    *!! quarterly estimates
    HL_minus_HH, event_prefix(FE33) pre_window_len(24) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/007EventStudiesWithMngrFEBasedMeasures/FE33_Outcome${number}_`var'_Coef2_Loss.gph", replace   
    ...
    *!! pre-event joint p-value
    pretrend_Double_Diff, event_prefix(FE33) pre_window_len(24)
    ...
    *!! post-event joint p-value
    postevent_Double_Diff, event_prefix(FE33) post_window_len(60)
    ...
    *!! quarterly estimates
    Double_Diff, event_prefix(FE33) pre_window_len(24) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/007EventStudiesWithMngrFEBasedMeasures/FE33_Outcome${number}_`var'_Coef3_GainsMinusLoss.gph", replace
...
save "${Results}/007EventStudiesWithMngrFEBasedMeasures/FE33_TwoMainOutcomes.dta", replace 
