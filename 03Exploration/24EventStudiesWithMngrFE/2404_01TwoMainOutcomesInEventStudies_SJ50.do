...
The high-flyer measure used here is SJ50.
...
Output:
    "${Results}/007EventStudiesWithMngrFEBasedMeasures/20250515log_TwoMainOutcomes_MeasureSJ50.txt"
    "${Results}/007EventStudiesWithMngrFEBasedMeasures/SJ50_TwoMainOutcomes.dta"
...
capture log close
log using "${Results}/007EventStudiesWithMngrFEBasedMeasures/20250515log_TwoMainOutcomes_MeasureSJ50.txt", replace text
...
keep if SJ50_LtoL!=.
    //impt: keep only those event workers whose event groups can be classified under SJ50 measure.
...
/* Naming patterns:
For normal "event * relative period" dummies, e.g. SJ50_LtoL_X_Pre1 SJ50_LtoH_X_Post0 SJ50_HtoH_X_Post12
For binned dummies, e.g. SJ50_LtoL_X_Pre_Before36 SJ50_LtoH_X_Post_After84
*/
...
generate  SJ50_Rel_Time = Rel_Time
summarize SJ50_Rel_Time, detail // range: [-131, +130]
...
*!! SJ50_LtoL
generate byte SJ50_LtoL_X_Pre_Before`max_pre_period' = SJ50_LtoL * (SJ50_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte SJ50_LtoL_X_Pre`time' = SJ50_LtoL * (SJ50_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte SJ50_LtoL_X_Post`time' = SJ50_LtoL * (SJ50_Rel_Time == `time')
}
generate byte SJ50_LtoL_X_Post_After`Lto_max_post_period' = SJ50_LtoL * (SJ50_Rel_Time > `Lto_max_post_period')

*!! SJ50_LtoH
generate byte SJ50_LtoH_X_Pre_Before`max_pre_period' = SJ50_LtoH * (SJ50_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte SJ50_LtoH_X_Pre`time' = SJ50_LtoH * (SJ50_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte SJ50_LtoH_X_Post`time' = SJ50_LtoH * (SJ50_Rel_Time == `time')
}
generate byte SJ50_LtoH_X_Post_After`Lto_max_post_period' = SJ50_LtoH * (SJ50_Rel_Time > `Lto_max_post_period')

*!! SJ50_HtoH 
generate byte SJ50_HtoH_X_Pre_Before`max_pre_period' = SJ50_HtoH * (SJ50_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte SJ50_HtoH_X_Pre`time' = SJ50_HtoH * (SJ50_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte SJ50_HtoH_X_Post`time' = SJ50_HtoH * (SJ50_Rel_Time == `time')
}
generate byte SJ50_HtoH_X_Post_After`Hto_max_post_period' = SJ50_HtoH * (SJ50_Rel_Time > `Hto_max_post_period')

*!! SJ50_HtoL 
generate byte SJ50_HtoL_X_Pre_Before`max_pre_period' = SJ50_HtoL * (SJ50_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte SJ50_HtoL_X_Pre`time' = SJ50_HtoL * (SJ50_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte SJ50_HtoL_X_Post`time' = SJ50_HtoL * (SJ50_Rel_Time == `time')
}
generate byte SJ50_HtoL_X_Post_After`Hto_max_post_period' = SJ50_HtoL * (SJ50_Rel_Time > `Hto_max_post_period')
...
macro drop SJ50_LtoL_X_Pre SJ50_LtoL_X_Post SJ50_LtoH_X_Pre SJ50_LtoH_X_Post SJ50_HtoH_X_Pre SJ50_HtoH_X_Post SJ50_HtoL_X_Pre SJ50_HtoL_X_Post

foreach event in SJ50_LtoL SJ50_LtoH {
...
foreach event in SJ50_HtoH SJ50_HtoL {
    global `event'_X_Pre `event'_X_Pre_Before`max_pre_period'
    forvalues time = `max_pre_period'(-1)4 {
        global `event'_X_Pre ${`event'_X_Pre} `event'_X_Pre`time'
    }
...
global four_events_dummies ${SJ50_LtoL_X_Pre} ${SJ50_LtoL_X_Post} ${SJ50_LtoH_X_Pre} ${SJ50_LtoH_X_Post} ${SJ50_HtoH_X_Pre} ${SJ50_HtoH_X_Post} ${SJ50_HtoL_X_Pre} ${SJ50_HtoL_X_Post}

display "${four_events_dummies}"

    // SJ50_LtoL_X_Pre_Before24 SJ50_LtoL_X_Pre24 ... SJ50_LtoL_X_Pre4 SJ50_LtoL_X_Post0 SJ50_LtoL_X_Post1 ... SJ50_LtoL_X_Post84 SJ50_LtoL_X_Pre_After84 
    // SJ50_LtoH_X_Pre_Before24 SJ50_LtoH_X_Pre24 ... SJ50_LtoH_X_Pre4 SJ50_LtoH_X_Post0 SJ50_LtoH_X_Post1 ... SJ50_LtoH_X_Post84 SJ50_LtoH_X_Pre_After84 
    // SJ50_HtoH_X_Pre_Before24 SJ50_HtoH_X_Pre24 ... SJ50_HtoH_X_Pre4 SJ50_HtoH_X_Post0 SJ50_HtoH_X_Post1 ... SJ50_HtoH_X_Post60 SJ50_HtoH_X_Pre_After60 
    // SJ50_HtoL_X_Pre_Before24 SJ50_HtoL_X_Pre24 ... SJ50_HtoL_X_Pre4 SJ50_HtoL_X_Post0 SJ50_HtoL_X_Post1 ... SJ50_HtoL_X_Post60 SJ50_HtoL_X_Pre_After60 
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! pre-event joint p-value
    pretrend_LH_minus_LL, event_prefix(SJ50) pre_window_len(24)
    ...
    *!! quarterly estimates
    LH_minus_LL, event_prefix(SJ50) pre_window_len(24) post_window_len(84) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/007EventStudiesWithMngrFEBasedMeasures/SJ50_Outcome${number}_`var'_Coef1_Gains.gph", replace
    ...
    *!! pre-event joint p-value
    pretrend_HL_minus_HH, event_prefix(SJ50) pre_window_len(24)
    ...
    *!! quarterly estimates
    HL_minus_HH, event_prefix(SJ50) pre_window_len(24) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/007EventStudiesWithMngrFEBasedMeasures/SJ50_Outcome${number}_`var'_Coef2_Loss.gph", replace   
    ...
    *!! pre-event joint p-value
    pretrend_Double_Diff, event_prefix(SJ50) pre_window_len(24)
    ...
    *!! post-event joint p-value
    postevent_Double_Diff, event_prefix(SJ50) post_window_len(60)
    ...
    *!! quarterly estimates
    Double_Diff, event_prefix(SJ50) pre_window_len(24) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/007EventStudiesWithMngrFEBasedMeasures/SJ50_Outcome${number}_`var'_Coef3_GainsMinusLoss.gph", replace
...
save "${Results}/007EventStudiesWithMngrFEBasedMeasures/SJ50_TwoMainOutcomes.dta", replace 
