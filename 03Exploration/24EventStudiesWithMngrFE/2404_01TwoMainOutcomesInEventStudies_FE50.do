...
The high-flyer measure used here is FE50.
...
Output:
    "${Results}/007EventStudiesWithMngrFEBasedMeasures/20250515log_TwoMainOutcomes_MeasureFE50.txt"
    "${Results}/007EventStudiesWithMngrFEBasedMeasures/FE50_TwoMainOutcomes.dta"
...
capture log close
log using "${Results}/007EventStudiesWithMngrFEBasedMeasures/20250515log_TwoMainOutcomes_MeasureFE50.txt", replace text
...
keep if FE50_LtoL!=.
    //impt: keep only those event workers whose event groups can be classified under FE50 measure.
...
/* Naming patterns:
For normal "event * relative period" dummies, e.g. FE50_LtoL_X_Pre1 FE50_LtoH_X_Post0 FE50_HtoH_X_Post12
For binned dummies, e.g. FE50_LtoL_X_Pre_Before36 FE50_LtoH_X_Post_After84
*/
...
generate  FE50_Rel_Time = Rel_Time
summarize FE50_Rel_Time, detail // range: [-131, +130]
...
*!! FE50_LtoL
generate byte FE50_LtoL_X_Pre_Before`max_pre_period' = FE50_LtoL * (FE50_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte FE50_LtoL_X_Pre`time' = FE50_LtoL * (FE50_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte FE50_LtoL_X_Post`time' = FE50_LtoL * (FE50_Rel_Time == `time')
}
generate byte FE50_LtoL_X_Post_After`Lto_max_post_period' = FE50_LtoL * (FE50_Rel_Time > `Lto_max_post_period')

*!! FE50_LtoH
generate byte FE50_LtoH_X_Pre_Before`max_pre_period' = FE50_LtoH * (FE50_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte FE50_LtoH_X_Pre`time' = FE50_LtoH * (FE50_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte FE50_LtoH_X_Post`time' = FE50_LtoH * (FE50_Rel_Time == `time')
}
generate byte FE50_LtoH_X_Post_After`Lto_max_post_period' = FE50_LtoH * (FE50_Rel_Time > `Lto_max_post_period')

*!! FE50_HtoH 
generate byte FE50_HtoH_X_Pre_Before`max_pre_period' = FE50_HtoH * (FE50_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte FE50_HtoH_X_Pre`time' = FE50_HtoH * (FE50_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte FE50_HtoH_X_Post`time' = FE50_HtoH * (FE50_Rel_Time == `time')
}
generate byte FE50_HtoH_X_Post_After`Hto_max_post_period' = FE50_HtoH * (FE50_Rel_Time > `Hto_max_post_period')

*!! FE50_HtoL 
generate byte FE50_HtoL_X_Pre_Before`max_pre_period' = FE50_HtoL * (FE50_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte FE50_HtoL_X_Pre`time' = FE50_HtoL * (FE50_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte FE50_HtoL_X_Post`time' = FE50_HtoL * (FE50_Rel_Time == `time')
}
generate byte FE50_HtoL_X_Post_After`Hto_max_post_period' = FE50_HtoL * (FE50_Rel_Time > `Hto_max_post_period')
...
macro drop FE50_LtoL_X_Pre FE50_LtoL_X_Post FE50_LtoH_X_Pre FE50_LtoH_X_Post FE50_HtoH_X_Pre FE50_HtoH_X_Post FE50_HtoL_X_Pre FE50_HtoL_X_Post

foreach event in FE50_LtoL FE50_LtoH {
...
foreach event in FE50_HtoH FE50_HtoL {
    global `event'_X_Pre `event'_X_Pre_Before`max_pre_period'
    forvalues time = `max_pre_period'(-1)4 {
        global `event'_X_Pre ${`event'_X_Pre} `event'_X_Pre`time'
    }
...
global four_events_dummies ${FE50_LtoL_X_Pre} ${FE50_LtoL_X_Post} ${FE50_LtoH_X_Pre} ${FE50_LtoH_X_Post} ${FE50_HtoH_X_Pre} ${FE50_HtoH_X_Post} ${FE50_HtoL_X_Pre} ${FE50_HtoL_X_Post}

display "${four_events_dummies}"

    // FE50_LtoL_X_Pre_Before24 FE50_LtoL_X_Pre24 ... FE50_LtoL_X_Pre4 FE50_LtoL_X_Post0 FE50_LtoL_X_Post1 ... FE50_LtoL_X_Post84 FE50_LtoL_X_Pre_After84 
    // FE50_LtoH_X_Pre_Before24 FE50_LtoH_X_Pre24 ... FE50_LtoH_X_Pre4 FE50_LtoH_X_Post0 FE50_LtoH_X_Post1 ... FE50_LtoH_X_Post84 FE50_LtoH_X_Pre_After84 
    // FE50_HtoH_X_Pre_Before24 FE50_HtoH_X_Pre24 ... FE50_HtoH_X_Pre4 FE50_HtoH_X_Post0 FE50_HtoH_X_Post1 ... FE50_HtoH_X_Post60 FE50_HtoH_X_Pre_After60 
    // FE50_HtoL_X_Pre_Before24 FE50_HtoL_X_Pre24 ... FE50_HtoL_X_Pre4 FE50_HtoL_X_Post0 FE50_HtoL_X_Post1 ... FE50_HtoL_X_Post60 FE50_HtoL_X_Pre_After60 
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! pre-event joint p-value
    pretrend_LH_minus_LL, event_prefix(FE50) pre_window_len(24)
    ...
    *!! quarterly estimates
    LH_minus_LL, event_prefix(FE50) pre_window_len(24) post_window_len(84) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/007EventStudiesWithMngrFEBasedMeasures/FE50_Outcome${number}_`var'_Coef1_Gains.gph", replace
    ...
    *!! pre-event joint p-value
    pretrend_HL_minus_HH, event_prefix(FE50) pre_window_len(24)
    ...
    *!! quarterly estimates
    HL_minus_HH, event_prefix(FE50) pre_window_len(24) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/007EventStudiesWithMngrFEBasedMeasures/FE50_Outcome${number}_`var'_Coef2_Loss.gph", replace   
    ...
    *!! pre-event joint p-value
    pretrend_Double_Diff, event_prefix(FE50) pre_window_len(24)
    ...
    *!! post-event joint p-value
    postevent_Double_Diff, event_prefix(FE50) post_window_len(60)
    ...
    *!! quarterly estimates
    Double_Diff, event_prefix(FE50) pre_window_len(24) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/007EventStudiesWithMngrFEBasedMeasures/FE50_Outcome${number}_`var'_Coef3_GainsMinusLoss.gph", replace
...
save "${Results}/007EventStudiesWithMngrFEBasedMeasures/FE50_TwoMainOutcomes.dta", replace 
