...
Output:
    "${Results}/005EventStudiesWithCA30/20250506log_TwoMainOutcomes_Type2_Pre24Post120Post120.txt"
    "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_Pre24Post120Post120.dta"
...
capture log close
log using "${Results}/005EventStudiesWithCA30/20250506log_TwoMainOutcomes_Type2_Pre24Post120Post120.txt", replace text
...
For binned dummies, e.g. CA30_LtoL_X_Pre_Before36 CA30_LtoH_X_Post_After120
*/
...
local Lto_max_post_period = 120
local Hto_max_post_period = 120
...
display "${four_events_dummies}"
    ...
    // CA30_LtoL_X_Pre_Before24 CA30_LtoL_X_Pre24 ... CA30_LtoL_X_Pre4 CA30_LtoL_X_Post0 CA30_LtoL_X_Post1 ... CA30_LtoL_X_Post120 CA30_LtoL_X_Pre_After120 
    // CA30_LtoH_X_Pre_Before24 CA30_LtoH_X_Pre24 ... CA30_LtoH_X_Pre4 CA30_LtoH_X_Post0 CA30_LtoH_X_Post1 ... CA30_LtoH_X_Post120 CA30_LtoH_X_Pre_After120 
    // CA30_HtoH_X_Pre_Before24 CA30_HtoH_X_Pre24 ... CA30_HtoH_X_Pre4 CA30_HtoH_X_Post0 CA30_HtoH_X_Post1 ... CA30_HtoH_X_Post120  CA30_HtoH_X_Pre_After120 
    // CA30_HtoL_X_Pre_Before24 CA30_HtoL_X_Pre24 ... CA30_HtoL_X_Pre4 CA30_HtoL_X_Post0 CA30_HtoL_X_Post1 ... CA30_HtoL_X_Post120  CA30_HtoL_X_Pre_After120 
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    LH_minus_LL, event_prefix(CA30) pre_window_len(24) post_window_len(120) outcome(`var')
    twoway ///
        ...
        xlabel(-8(2)40, grid gstyle(dot) labsize(medsmall)) /// 
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef1_Gains_Type2_Pre24Post120Post120.gph", replace
    ...
    *!! quarterly estimates
    HL_minus_HH, event_prefix(CA30) pre_window_len(24) post_window_len(120) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef2_Loss_Type2_Pre24Post120Post120.gph", replace   
    ...
    *!! post-event joint p-value
    postevent_Double_Diff, event_prefix(CA30) post_window_len(120)
    ...
    *!! quarterly estimates
    Double_Diff, event_prefix(CA30) pre_window_len(24) post_window_len(120) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef3_GainsMinusLoss_Type2_Pre24Post120Post120.gph", replace
...
keep if inrange(_n, 1, 100)

save "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_Pre24Post120Post120.dta", replace 
