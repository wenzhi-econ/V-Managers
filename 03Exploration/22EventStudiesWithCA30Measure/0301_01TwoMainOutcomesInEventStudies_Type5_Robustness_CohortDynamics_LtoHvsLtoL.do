...
Output:
    "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type5_Robustness_CohortDynamics_LtoHvsLtoL.txt"
    "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_CohortDynamics_LtoHvsLtoL.dta"
...
capture log close
log using "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type5_Robustness_CohortDynamics_LtoHvsLtoL.txt", replace text
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    ...
    twoway ///
        ...
        legend(off)
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef1_Gains_Type5_CohortDynamics.gph", replace
...
save "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_CohortDynamics_LtoHvsLtoL.dta", replace 
