...
Output:
    "${Results}/005EventStudiesWithCA30/20250502log_PayOutcomes.txt"
...
capture log close
log using "${Results}/005EventStudiesWithCA30/20250502log_PayOutcomes.txt", replace text
...
save "${Results}/005EventStudiesWithCA30/CA30_PayOutcomes.dta", replace 
