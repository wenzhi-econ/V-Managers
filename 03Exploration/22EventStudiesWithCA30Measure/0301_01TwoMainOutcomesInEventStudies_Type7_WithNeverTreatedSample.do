...
Output:
    "${Results}/005EventStudiesWithCA30/20250512log_TwoMainOutcomes_Type7_WithNeverTreatedSample.txt"
...
capture log close
log using "${Results}/005EventStudiesWithCA30/20250512log_TwoMainOutcomes_Type7_WithNeverTreatedSample.txt", replace text
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef1_Gains_Type7_WithNeverTreatedSample.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef2_Loss_Type7_WithNeverTreatedSample.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef3_GainsMinusLoss_Type7_WithNeverTreatedSample.gph", replace
...
save "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_WithNeverTreatedSample.dta", replace 
