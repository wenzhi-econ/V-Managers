...
Output:
    "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type1_Pre24Post84.txt"
    "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes.dta"
...
capture log close
log using "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type1_Pre24Post84.txt", replace text
...
save "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_Pre24Post84.dta", replace 
