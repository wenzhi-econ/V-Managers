...
Output:
    "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type6_Robustness_Poisson.txt"
...
capture log close
log using "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type6_Robustness_Poisson.txt", replace text
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    if "`var'" == "TransferSJVC"       global ylabelsetup -1(0.1)1
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef1_Gains_Type6_Poisson.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef2_Loss_Type6_Poisson.gph", replace   
...
save "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_Poisson.dta", replace 
