...
Output:
    "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type3_Robustness_SingleCohort.txt"
    "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_SingleCohort.dta"
...
capture log close
log using "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type3_Robustness_SingleCohort.txt", replace text
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef1_Gains_Type3_SingleCohort.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef2_Loss_Type3_SingleCohort.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef3_GainsMinusLoss_Type3_SingleCohort.gph", replace
...
save "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_SingleCohort.dta", replace 
