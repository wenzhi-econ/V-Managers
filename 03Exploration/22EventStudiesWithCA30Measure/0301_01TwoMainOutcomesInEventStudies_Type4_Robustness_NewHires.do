...
Output:
    "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type4_Robustness_NewHires.txt"
    "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_NewHires.dta"
...
capture log close
log using "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type4_Robustness_NewHires.txt", replace text
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef1_Gains_Type4_NewHires.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef2_Loss_Type4_NewHires.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef3_GainsMinusLoss_Type4_NewHires.gph", replace
...
save "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_NewHires.dta", replace 
