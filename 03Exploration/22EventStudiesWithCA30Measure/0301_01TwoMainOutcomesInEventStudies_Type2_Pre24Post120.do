...
Output:
    "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type2_Pre24Post120.txt"
    "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_Pre24Post120.dta"
...
capture log close
log using "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type2_Pre24Post120.txt", replace text
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef1_Gains_Type2_Pre24Post120.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef2_Loss_Type2_Pre24Post120.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef3_GainsMinusLoss_Type2_Pre24Post120.gph", replace
...
save "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_Pre24Post120.dta", replace 
