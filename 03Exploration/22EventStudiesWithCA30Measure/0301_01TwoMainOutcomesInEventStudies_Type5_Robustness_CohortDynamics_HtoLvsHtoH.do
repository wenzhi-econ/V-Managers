...
Notes on the event study regressions.
    ...
    (3) For HtoH and HtoL groups, the relative time period is [-36, +60].
...
Output:
    "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type5_Robustness_CohortDynamics_HtoLvsHtoH.txt"
    "${Results}/CA30_TwoMainOutcomes_CohortDynamics_HtoLvsHtoH.dta"
...
capture log close
log using "${Results}/005EventStudiesWithCA30/20250502log_TwoMainOutcomes_Type5_Robustness_CohortDynamics_HtoLvsHtoH.txt", replace text
...
For binned dummies, e.g. CA30_LtoL_X_Pre_Before36 CA30_HtoH_X_Post_After84
*/
...
display "${eventinteract}"
    ...
    // CA30_HtoH_X_Pre_Before36_2011 CA30_HtoH_X_Pre36_2011 ... CA30_HtoH_X_Pre4_2011 CA30_HtoH_X_Post0_2011 CA30_HtoH_X_Post1_2011 ... CA30_HtoH_X_Post84_2011 CA30_HtoH_X_Pre_After84_2011
    // ...
    // CA30_HtoH_X_Pre_Before36_2020 CA30_HtoH_X_Pre36_2020 ... CA30_HtoH_X_Pre4_2020 CA30_HtoH_X_Post0_2020 CA30_HtoH_X_Post1_2020 ... CA30_HtoH_X_Post84_2020 CA30_HtoH_X_Pre_After84_2020
    // CA30_HtoL_X_Pre_Before36_2011 CA30_HtoL_X_Pre36_2011 ... CA30_HtoL_X_Pre4_2011 CA30_HtoL_X_Post0_2011 CA30_HtoL_X_Post1_2011 ... CA30_HtoL_X_Post60_2011 CA30_HtoL_X_Pre_After60_2011 
    // ...
    // CA30_HtoL_X_Pre_Before36_2020 CA30_HtoL_X_Pre36_2020 ... CA30_HtoL_X_Pre4_2020 CA30_HtoL_X_Post0_2020 CA30_HtoL_X_Post1_2020 ... CA30_HtoL_X_Post60_2020 CA30_HtoL_X_Pre_After60_2020
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    ...
    twoway ///
        ...
        legend(off)
    graph save "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef2_Loss_Type5_CohortDynamics.gph", replace   
...
save "${Results}/005EventStudiesWithCA30/CA30_TwoMainOutcomes_CohortDynamics_HtoLvsHtoH.dta", replace 
