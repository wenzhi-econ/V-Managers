...
Output:
    "${Results}/20250429log_EventStudiesWithCA30_TwoMainOutcomes_Cohort1314.txt"
    "${Results}/CA30_TwoMainOutcomes_Cohorts1314.dta"
...
capture log close
log using "${Results}/20250429log_EventStudiesWithCA30_TwoMainOutcomes_Cohort1314", replace text
...
generate cohortSingle = 1 if Event_Time<=tm(2014m12) & Event_Time>=tm(2013m1)
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/CA30_Outcome${number}_Gains_`var'_Cohorts1314.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/CA30_Outcome${number}_Loss_`var'_Cohorts1314.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/CA30_Outcome${number}_GainsMinusLoss_`var'_Cohorts1314.gph", replace
...
save "${Results}/CA30_TwoMainOutcomes_Cohorts1314.dta", replace 
