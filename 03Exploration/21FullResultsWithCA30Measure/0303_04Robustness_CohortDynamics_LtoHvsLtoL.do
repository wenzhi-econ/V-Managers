...
Notes on the event study regressions.
    (1) To reduce the computational burden, only LtoH and LtoL event workers are included in the regressions. Never-treated workers are always not included.
    (2) The omitted group in the regressions are month -3, -2, and -1 for all four treatment groups.
    (3) For LtoL and LtoH groups, the relative time period is [-36, +84].
...
Output:
    "${Results}/20250415log_EventStudiesWithCA30_TwoMainOutcomes_CohortDynamics_LtoHvsLtoL.txt"
    "${Results}/CA30_TwoMainOutcomes_CohortDynamics_LtoHvsLtoL.dta"
...
capture log close
log using "${Results}/20250415log_EventStudiesWithCA30_TwoMainOutcomes_CohortDynamics_LtoHvsLtoL", replace text
...
display "${eventinteract}"
    ...
    // CA30_LtoL_X_Pre_Before36_2011 CA30_LtoL_X_Pre36_2011 ... CA30_LtoL_X_Pre4_2011 CA30_LtoL_X_Post0_2011 CA30_LtoL_X_Post1_2011 ... CA30_LtoL_X_Post84_2011 CA30_LtoL_X_Pre_After84_2011
    // ...
    // CA30_LtoL_X_Pre_Before36_2020 CA30_LtoL_X_Pre36_2020 ... CA30_LtoL_X_Pre4_2020 CA30_LtoL_X_Post0_2020 CA30_LtoL_X_Post1_2020 ... CA30_LtoL_X_Post84_2020 CA30_LtoL_X_Pre_After84_2020
    // CA30_LtoH_X_Pre_Before36_2011 CA30_LtoH_X_Pre36_2011 ... CA30_LtoH_X_Pre4_2011 CA30_LtoH_X_Post0_2011 CA30_LtoH_X_Post1_2011 ... CA30_LtoH_X_Post84_2011 CA30_LtoH_X_Pre_After84_2011
    // ...
    // CA30_LtoH_X_Pre_Before36_2020 CA30_LtoH_X_Pre36_2020 ... CA30_LtoH_X_Pre4_2020 CA30_LtoH_X_Post0_2020 CA30_LtoH_X_Post1_2020 ... CA30_LtoH_X_Post84_2020 CA30_LtoH_X_Pre_After84_2020
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    LH_minus_LL_CohortDynamics, event_prefix(CA30) pre_window_len(36) post_window_len(84) outcome(`var')
    twoway ///
        ...
        legend(off)
    graph save "${Results}/CA30_Outcome${number}_Gains_`var'_CohortDynamics_LtoHvsLtoL.gph", replace
...
save "${Results}/CA30_TwoMainOutcomes_CohortDynamics_LtoHvsLtoL.dta", replace 
