...
Output:
    "${Results}/20250414log_EventStudiesWithCA30_Outcome1_TwoMainOutcomes.txt"
    "${Results}/CA30_TwoMainOutcomes.dta"
...
capture log close
log using "${Results}/20250414log_EventStudiesWithCA30_Outcome1_TwoMainOutcomes", replace text
...
save "${Results}/CA30_TwoMainOutcomes.dta", replace 
