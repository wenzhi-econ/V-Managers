...
foreach var in ProductivityStd {
    ...
    *!! quarterly estimates
    ...
    graph export "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef1_Gains_Type5_2018m1to2021m12.pdf", replace as(pdf)
    ...
    *!! quarterly estimates
    ...
    graph export "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef2_Loss_Type5_2018m1to2021m12.pdf", replace as(pdf)   
    ...
    *!! quarterly estimates
    ...
    graph export "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef3_GainsMinusLoss_Type5_2018m1to2021m12.pdf", replace as(pdf)
}