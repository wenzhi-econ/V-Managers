...
generate Prod = log(ProductivityStd + 1)
...
display "${four_events_dummies}"
    ...
    // CA30_LtoL_X_Pre_Before6 CA30_LtoL_X_Pre6 ... CA30_LtoL_X_Pre4 CA30_LtoL_X_Post0 CA30_LtoL_X_Post1 ... CA30_LtoL_X_Post36 CA30_LtoL_X_Pre_After36 
    // CA30_LtoH_X_Pre_Before6 CA30_LtoH_X_Pre6 ... CA30_LtoH_X_Pre4 CA30_LtoH_X_Post0 CA30_LtoH_X_Post1 ... CA30_LtoH_X_Post36 CA30_LtoH_X_Pre_After36 
    // CA30_HtoH_X_Pre_Before6 CA30_HtoH_X_Pre6 ... CA30_HtoH_X_Pre4 CA30_HtoH_X_Post0 CA30_HtoH_X_Post1 ... CA30_HtoH_X_Post36 CA30_HtoH_X_Pre_After36 
    // CA30_HtoL_X_Pre_Before6 CA30_HtoL_X_Pre6 ... CA30_HtoL_X_Pre4 CA30_HtoL_X_Post0 CA30_HtoL_X_Post1 ... CA30_HtoL_X_Post36 CA30_HtoL_X_Pre_After36 
...
foreach var in Prod {
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/004ResultsBasedOnCA30/CA30_Outcome${number}_Gains_`var'_36PostPeriods.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/004ResultsBasedOnCA30/CA30_Outcome${number}_Loss_`var'_36PostPeriods.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/004ResultsBasedOnCA30/CA30_Outcome${number}_GainsMinusLoss_`var'_36PostPeriods.gph", replace
