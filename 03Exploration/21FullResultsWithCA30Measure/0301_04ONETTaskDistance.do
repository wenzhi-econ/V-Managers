...
Output:
    "${Results}/20250414log_EventStudiesWithCA30_Outcome4_ONETOutcome"
    "${Results}/CA30_ONETDistC.dta"
...
capture log close
log using "${Results}/20250414log_EventStudiesWithCA30_Outcome4_ONETOutcome", replace text
...
save "${Results}/CA30_ONETDistC.dta", replace 
