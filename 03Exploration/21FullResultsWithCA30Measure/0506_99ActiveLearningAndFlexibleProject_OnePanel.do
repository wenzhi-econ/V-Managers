...
global latex_numbers_A    "& \multicolumn{1}{c}{(1)} & \multicolumn{1}{c}{(2)} & \multicolumn{1}{c}{(3)} & \multicolumn{1}{c}{(4)} \\"
global latex_titles_A     "& \multicolumn{1}{c}{Profile completed} & \multicolumn{1}{c}{\shortstack{Applied to any \\ project role}}  & \multicolumn{1}{c}{\shortstack{Number of project \\ roles applied}} & \multicolumn{1}{c}{\shortstack{Number of \\ skills}} \\"
global latex_file         "${Results}/004ResultsBasedOnCA30/ActiveLearningAndFlexibleProject_OnePanel.tex"

esttab CompletedProfileDummy ProjectRolesAppliedDummy NrProjectRolesApplied NumSkills using "${latex_file}", ///
    ...
    prehead("${latex_star}" "${latex_begintabular}" "${latex_toprule}" "${latex_toprule}") posthead("${latex_titles_A}" "${latex_numbers_A}" "${latex_midrule}") ///
