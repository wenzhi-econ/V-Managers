...
sys.path.append("E:\\__RA\\02MANAGERS\\Paper Managers\\DoFiles\\01Main")

import _pysetup as setup

path_skills = os.path.join(setup.rawmnedata_directory, "SkillsInput.dta")
path_output_data = os.path.join(setup.tempdata_directory, "0704_01SkillsAfterLDA.dta")
...
#     top_words_2_topics_1000, path_output_fig, "LDA2_1000Words"
# )
# generate_word_clouds(
#     top_words_5_topics_1000, path_output_fig, "LDA5_1000Words"
# )
