...
Output:
    "${Results}/20250415log_EventStudiesWithCA30_TwoMainOutcomes_SingleCohort.txt"
    "${Results}/CA30_TwoMainOutcomes_SingleCohort.dta"
...
capture log close
log using "${Results}/20250415log_EventStudiesWithCA30_TwoMainOutcomes_SingleCohort", replace text
...
generate cohortSingle = 1 if Event_Time<=tm(2014m12) & Event_Time>=tm(2014m1)
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/CA30_Outcome${number}_Gains_`var'_SingleCohort.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/CA30_Outcome${number}_Loss_`var'_SingleCohort.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/CA30_Outcome${number}_GainsMinusLoss_`var'_SingleCohort.gph", replace
...
save "${Results}/CA30_TwoMainOutcomes_SingleCohort.dta", replace 
