...
Output:
    "${Results}/20250429log_EventStudiesWithCA30_TwoMainOutcomes_Cohorts1415.txt"
    "${Results}/CA30_TwoMainOutcomes_Cohorts1415.dta"
...
capture log close
log using "${Results}/20250429log_EventStudiesWithCA30_TwoMainOutcomes_Cohorts1415", replace text
...
generate cohortSingle = 1 if Event_Time<=tm(2015m12) & Event_Time>=tm(2014m1)
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/CA30_Outcome${number}_Gains_`var'_Cohorts1415.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/CA30_Outcome${number}_Loss_`var'_Cohorts1415.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/CA30_Outcome${number}_GainsMinusLoss_`var'_Cohorts1415.gph", replace
...
save "${Results}/CA30_TwoMainOutcomes_Cohorts1415.dta", replace 
