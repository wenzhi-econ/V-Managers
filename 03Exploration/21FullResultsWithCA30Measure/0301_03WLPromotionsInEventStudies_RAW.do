...
Output:
    "${Results}/20250414log_EventStudiesWithCA30_Outcome3_WLPromotions.txt"
    "${Results}/CA30_WLPromotions.dta"
...
capture log close
log using "${Results}/20250414log_EventStudiesWithCA30_Outcome3_WLPromotions", replace text
...
save "${Results}/CA30_WLPromotions.dta", replace 
