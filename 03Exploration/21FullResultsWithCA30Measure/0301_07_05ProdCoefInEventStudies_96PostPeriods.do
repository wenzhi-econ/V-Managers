...
display "${four_events_dummies}"
    ...
    // CA30_LtoL_X_Pre_Before6 CA30_LtoL_X_Pre6 CA30_LtoL_X_Pre5 ... CA30_LtoL_X_Pre4 CA30_LtoL_X_Post0 CA30_LtoL_X_Post1 ... CA30_LtoL_X_Post96 CA30_LtoL_X_Pre_After96 
    // CA30_LtoH_X_Pre_Before6 CA30_LtoH_X_Pre6 CA30_LtoH_X_Pre5 ... CA30_LtoH_X_Pre4 CA30_LtoH_X_Post0 CA30_LtoH_X_Post1 ... CA30_LtoH_X_Post96 CA30_LtoH_X_Pre_After96 
...
foreach var in ProductivityStd {
    ...
    *!! quarterly estimates
    LH_minus_LL, event_prefix(CA30) pre_window_len(6) post_window_len(96) outcome(`var') statistics(0)
    twoway ///
        ...
        xlabel(-2(2)32, grid gstyle(dot) labsize(medsmall)) /// 
    ...
    graph export "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef1_Gains_Pre6Post96.pdf", replace as(pdf)
    ...
    *!! quarterly estimates
    ...
    graph export "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef2_Loss_Pre6Post96.pdf", replace as(pdf)   
    ...
    *!! quarterly estimates
    ...
    graph export "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef3_GainsMinusLoss_Pre6Post96.pdf", replace as(pdf)
