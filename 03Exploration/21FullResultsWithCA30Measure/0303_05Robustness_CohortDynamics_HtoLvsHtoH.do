...
Output:
    "${Results}/20250415log_EventStudiesWithCA30_TwoMainOutcomes_CohortDynamics_HtoLvsHtoH.txt"
...
capture log close
log using "${Results}/20250415log_EventStudiesWithCA30_TwoMainOutcomes_CohortDynamics_HtoLvsHtoH", replace text
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    HL_minus_HH_CohortDynamics, event_prefix(CA30) pre_window_len(36) post_window_len(60) outcome(`var')
    twoway ///
        ...
        legend(off)
    graph save "${Results}//CA30_Outcome${number}_Loss_`var'_CohortDynamics_HtoLvsHtoH.gph", replace   
...
save "${Results}/CA30_TwoMainOutcomes_CohortDynamics_HtoLvsHtoH.dta", replace 
