...
Output:
    "${Results}/20250414log_EventStudiesWithCA30_Outcome5_ProbLateralTransfer.txt"
...
capture log close
log using "${Results}/20250414log_EventStudiesWithCA30_Outcome5_ProbLateralTransfer", replace text
...
save "${Results}/CA30_ProbLateralTransfer.dta", replace 
