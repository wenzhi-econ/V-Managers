/* 
This do file runs event studies on the productivity outcomes on a balanced employee panel.
...
display "${four_events_dummies}"
    ...
    // CA30_LtoL_X_Pre_Before6 CA30_LtoL_X_Pre6 CA30_LtoL_X_Pre5 ... CA30_LtoL_X_Pre4 CA30_LtoL_X_Post0 CA30_LtoL_X_Post1 ... CA30_LtoL_X_Post36 CA30_LtoL_X_Pre_After36 
    // CA30_LtoH_X_Pre_Before6 CA30_LtoH_X_Pre6 CA30_LtoH_X_Pre5 ... CA30_LtoH_X_Pre4 CA30_LtoH_X_Post0 CA30_LtoH_X_Post1 ... CA30_LtoH_X_Post36 CA30_LtoH_X_Pre_After36 
    // CA30_HtoH_X_Pre_Before6 CA30_HtoH_X_Pre6 CA30_HtoH_X_Pre5 ... CA30_HtoH_X_Pre4 CA30_HtoH_X_Post0 CA30_HtoH_X_Post1 ... CA30_HtoH_X_Post36 CA30_HtoH_X_Pre_After36 
    // CA30_HtoL_X_Pre_Before6 CA30_HtoL_X_Pre6 CA30_HtoL_X_Pre5 ... CA30_HtoL_X_Pre4 CA30_HtoL_X_Post0 CA30_HtoL_X_Post1 ... CA30_HtoL_X_Post36 CA30_HtoL_X_Pre_After36 
...
foreach var in ProductivityStd {
    ...
    *!! quarterly estimates
    LH_minus_LL, event_prefix(CA30) pre_window_len(6) post_window_len(36) outcome(`var') statistics(0)
    twoway ///
    ...
    graph export "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef1_Gains_Type1_BalancedPanelSample_36PostPeriods.pdf", replace as(pdf)
    ...
    *!! quarterly estimates
    HL_minus_HH, event_prefix(CA30) pre_window_len(6) post_window_len(36) outcome(`var')
    twoway ///
    ...
    graph export "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef2_Loss_Type1_BalancedPanelSample_36PostPeriods.pdf", replace as(pdf)   
    ...
    *!! post-event joint p-value
    postevent_Double_Diff, event_prefix(CA30) post_window_len(6)
    ...
    *!! quarterly estimates
    Double_Diff, event_prefix(CA30) pre_window_len(6) post_window_len(36) outcome(`var')
    twoway ///
    ...
    graph export "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef3_GainsMinusLoss_Type1_BalancedPanelSample_36PostPeriods.pdf", replace as(pdf)
}
