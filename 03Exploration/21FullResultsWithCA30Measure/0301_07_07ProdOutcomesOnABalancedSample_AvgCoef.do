...
display "${four_events_dummies}"
    ...
    // CA30_LtoL_X_Pre_Before6 CA30_LtoL_X_Pre6 ... CA30_LtoL_X_Pre4 CA30_LtoL_X_Post0 CA30_LtoL_X_Post1 ... CA30_LtoL_X_Post96 CA30_LtoL_X_Pre_After96 
    // CA30_LtoH_X_Pre_Before6 CA30_LtoH_X_Pre6 ... CA30_LtoH_X_Pre4 CA30_LtoH_X_Post0 CA30_LtoH_X_Post1 ... CA30_LtoH_X_Post96 CA30_LtoH_X_Pre_After96 
...
global coef_2yr_to_4yr 
    ...
    + (CA30_LtoH_X_Post47 - CA30_LtoL_X_Post47))/24;

global coef_4yr_to_6yr 
    ...
    + (CA30_LtoH_X_Post71 - CA30_LtoL_X_Post71))/24;

global coef_6yr_to_8yr
    ...
    + (CA30_LtoH_X_Post84 - CA30_LtoL_X_Post84)
    + (CA30_LtoH_X_Post85 - CA30_LtoL_X_Post85)
    + (CA30_LtoH_X_Post86 - CA30_LtoL_X_Post86)
    + (CA30_LtoH_X_Post87 - CA30_LtoL_X_Post87)
    + (CA30_LtoH_X_Post88 - CA30_LtoL_X_Post88)
    + (CA30_LtoH_X_Post89 - CA30_LtoL_X_Post89)
    + (CA30_LtoH_X_Post90 - CA30_LtoL_X_Post90)
    + (CA30_LtoH_X_Post91 - CA30_LtoL_X_Post91)
    + (CA30_LtoH_X_Post92 - CA30_LtoL_X_Post92)
    + (CA30_LtoH_X_Post93 - CA30_LtoL_X_Post93)
    + (CA30_LtoH_X_Post94 - CA30_LtoL_X_Post94)
    + (CA30_LtoH_X_Post95 - CA30_LtoL_X_Post95)
    + (CA30_LtoH_X_Post96 - CA30_LtoL_X_Post96))/25;
...
global latex_file         "${Results}/005EventStudiesWithCA30/CA30_AvgProdCoefInEventStudies_96PostPeriods.tex"
...
esttab Full_ProductivityStd Full_LogPayBonus Full_TransferSJVC Full_ChangeSalaryGradeC using "${latex_file}", ///
    ...
    varlabels(coef_0y_to_2yr "Average effects 0-2 years after the event" coef_2yr_to_4yr "Average effects 2-4 years after the event" coef_4yr_to_6yr "Average effects 4-6 years after the event" coef_6yr_to_8yr "Average effects 6-8 years after the event") ///
