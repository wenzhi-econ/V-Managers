...
foreach y in  $perf $div $homo {
    ...
    reghdfe `y' CA30_LtoH CA30_HtoH CA30_HtoL if spanM>1 & inrange(Rel_Time, -30, -6), cluster(IDlseMHRPreMost) absorb($controls)
...
global latex_file         "${Results}/004ResultsBasedOnCA30/CA30_EndogenousMobilityChecks_FullTransition_Pre30toPre6.tex"
