...
codebook IDlse
    //&? 1,611 distinct employees before the "balanced sample" restriction

keep if Min_RelTime<0 & Max_RelTime>0
    //impt: keep a "balanced sample" -- employees with non-missing productivity outcomes in both pre- and post-event periods.
    //&? 7,496 total observations

codebook IDlse
    //&? 245 distinct employees before the "balanced sample" restriction
...
foreach var in ProductivityStd {
    ...
    *!! quarterly estimates
    ...
    graph export "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef1_Gains_Type1_BalancedPanelSample.pdf", replace as(pdf)
    ...
    *!! quarterly estimates
    ...
    graph export "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef2_Loss_Type1_BalancedPanelSample.pdf", replace as(pdf)   
    ...
    *!! quarterly estimates
    ...
    graph export "${Results}/005EventStudiesWithCA30/CA30_Outcome${number}_`var'_Coef3_GainsMinusLoss_Type1_BalancedPanelSample.pdf", replace as(pdf)
}
