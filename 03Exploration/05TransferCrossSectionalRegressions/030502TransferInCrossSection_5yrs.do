...
bysort IDlse: egen     total_AE_TransferSJV  = total(AE_TransferSJV) if inrange(FT_Rel_Time, 0, 60)
codebook total_AE_TransferSJV
...
save "${TempData}/temp_NumberOfLateralMoves_CrossSection_5yrs.dta", replace

*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??
*?? step 2. run cross-sectional regressions  
*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??

use "${TempData}/temp_NumberOfLateralMoves_CrossSection_5yrs.dta", clear 

summarize FT_Event_Time, detail 
global LastMonth = r(max)
global LastPossibleEventTime = ${LastMonth} - 60
...
twoway ///
    ...
    xlabel(0(1)3) ///
    xtitle("Number of lateral moves within 5 years after the event") ///
    ytitle("Coefficient on LtoH") ///
    legend(off)
graph export "${Results}/FT_Gains_NumberOfLateralMoves_5yrs.pdf", as(pdf) replace 
...
twoway ///
    ...
    legend(off)
graph export "${Results}/FT_Loss_NumberOfLateralMoves_5yrs.pdf", as(pdf) replace 
