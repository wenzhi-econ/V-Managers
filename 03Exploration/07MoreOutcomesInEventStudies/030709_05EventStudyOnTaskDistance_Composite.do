/* 
This do file runs event studies on the task distance measures compositely for cognitive, routine, and social tasks.
...
foreach var in cumdist {
    ...
    if "`var'" == "cumdist" global title "Cumulative distance in task intensity"
...
save "${Results}/FT_TaskDistanceMeasure_Composite.dta", replace 
