...
Input: 
    ...
    "${TempData}/031900_01AgeBandUpdated.dta" <== created in 031900_01 do file 

Output:
    "${TempData}/031900_02AgeContinuous.dta"
...
merge 1:1 IDlse YearMonth using "${TempData}/031900_01AgeBandUpdated.dta", keep(match master) nogenerate
