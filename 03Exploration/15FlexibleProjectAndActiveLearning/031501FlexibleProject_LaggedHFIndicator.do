...
foreach var in InFLEX CompletedProfileDummy AvailableJobs AvailableMentor PositionsAppliedDummy { 
    reghdfe `var' EarlyAgeM_lag12 if Post==1 & Year>2019, absorb(Year ISOCode) cluster(IDlseMHR)  
        eststo `var'1
        summarize `var' if e(sample)==1 & EarlyAgeM_lag12==0 
        estadd scalar cmean = r(mean)
}
esttab InFLEX1 CompletedProfileDummy1 AvailableJobs1 AvailableMentor1 PositionsAppliedDummy1
...
foreach var in InFLEX CompletedProfileDummy AvailableJobs AvailableMentor PositionsAppliedDummy { 
    reghdfe `var' EarlyAgeM_lag24 if Post==1 & Year>2019, absorb(Year ISOCode) cluster(IDlseMHR)  
        eststo `var'2
        summarize `var' if e(sample)==1 & EarlyAgeM_lag24==0 
        estadd scalar cmean = r(mean)
}
esttab InFLEX2 CompletedProfileDummy2 AvailableJobs2 AvailableMentor2 PositionsAppliedDummy2
...
foreach var in InFLEX CompletedProfileDummy AvailableJobs AvailableMentor PositionsAppliedDummy { 
    reghdfe `var' EarlyAgeM_lag48 if Post==1 & Year>2019, absorb(Year ISOCode) cluster(IDlseMHR)  
        eststo `var'4
        summarize `var' if e(sample)==1 & EarlyAgeM_lag48==0 
        estadd scalar cmean = r(mean)
}
esttab InFLEX4 CompletedProfileDummy4 AvailableJobs4 AvailableMentor4 PositionsAppliedDummy4
...
esttab InFLEX0 CompletedProfileDummy0 AvailableJobs0 AvailableMentor0 PositionsAppliedDummy0 using "${Results}/FTFlexibleProjects_Lag0.tex", ///
...
esttab InFLEX1 CompletedProfileDummy1 AvailableJobs1 AvailableMentor1 PositionsAppliedDummy1 using "${Results}/FTFlexibleProjects_Lag1.tex", ///
    replace style(tex) fragment nocons label nofloat nobaselevels se ///
    nomtitles collabels(,none) ///
    stats(cmean N, labels("Mean, low-flyer" "N") fmt(%9.3f %9.0f)) ///
    prehead("\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}" "\begin{tabular}{lccccc}" "\toprule" "\toprule" "& \multicolumn{1}{c}{Registered on Platform} & \multicolumn{1}{c}{Profile Completed}  & \multicolumn{1}{c}{Available for Jobs} & \multicolumn{1}{c}{Available for Mentors} & \multicolumn{1}{c}{Applied to Position}  \\") ///
...
esttab InFLEX2 CompletedProfileDummy2 AvailableJobs2 AvailableMentor2 PositionsAppliedDummy2 using "${Results}/FTFlexibleProjects_Lag2.tex", ///
    replace style(tex) fragment nocons label nofloat nobaselevels se ///
    nomtitles collabels(,none) ///
    stats(cmean N, labels("Mean, low-flyer" "N") fmt(%9.3f %9.0f)) ///
    prehead("\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}" "\begin{tabular}{lccccc}" "\toprule" "\toprule" "& \multicolumn{1}{c}{Registered on Platform} & \multicolumn{1}{c}{Profile Completed}  & \multicolumn{1}{c}{Available for Jobs} & \multicolumn{1}{c}{Available for Mentors} & \multicolumn{1}{c}{Applied to Position}  \\") ///
...
esttab InFLEX3 CompletedProfileDummy3 AvailableJobs3 AvailableMentor3 PositionsAppliedDummy3 using "${Results}/FTFlexibleProjects_Lag3.tex", ///
    replace style(tex) fragment nocons label nofloat nobaselevels se ///
    nomtitles collabels(,none) ///
    stats(cmean N, labels("Mean, low-flyer" "N") fmt(%9.3f %9.0f)) ///
    prehead("\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}" "\begin{tabular}{lccccc}" "\toprule" "\toprule" "& \multicolumn{1}{c}{Registered on Platform} & \multicolumn{1}{c}{Profile Completed}  & \multicolumn{1}{c}{Available for Jobs} & \multicolumn{1}{c}{Available for Mentors} & \multicolumn{1}{c}{Applied to Position}  \\") ///
...
esttab InFLEX4 CompletedProfileDummy4 AvailableJobs4 AvailableMentor4 PositionsAppliedDummy4 using "${Results}/FTFlexibleProjects_Lag4.tex", ///
    replace style(tex) fragment nocons label nofloat nobaselevels se ///
    nomtitles collabels(,none) ///
    stats(cmean N, labels("Mean, low-flyer" "N") fmt(%9.3f %9.0f)) ///
    prehead("\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}" "\begin{tabular}{lccccc}" "\toprule" "\toprule" "& \multicolumn{1}{c}{Registered on Platform} & \multicolumn{1}{c}{Profile Completed}  & \multicolumn{1}{c}{Available for Jobs} & \multicolumn{1}{c}{Available for Mentors} & \multicolumn{1}{c}{Applied to Position}  \\") ///
...
esttab InFLEX5 CompletedProfileDummy5 AvailableJobs5 AvailableMentor5 PositionsAppliedDummy5 using "${Results}/FTFlexibleProjects_Lag5.tex", ///
    replace style(tex) fragment nocons label nofloat nobaselevels se ///
    nomtitles collabels(,none) ///
    stats(cmean N, labels("Mean, low-flyer" "N") fmt(%9.3f %9.0f)) ///
    prehead("\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}" "\begin{tabular}{lccccc}" "\toprule" "\toprule" "& \multicolumn{1}{c}{Registered on Platform} & \multicolumn{1}{c}{Profile Completed}  & \multicolumn{1}{c}{Available for Jobs} & \multicolumn{1}{c}{Available for Mentors} & \multicolumn{1}{c}{Applied to Position}  \\") ///
