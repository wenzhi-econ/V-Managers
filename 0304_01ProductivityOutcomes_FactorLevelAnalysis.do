/* 
This do file aims to replicate Figure VI in the paper (June 14, 2024 version).
...
reghdfe lcfr shareHF TotWorkersWC TotWorkersBC MShare EarlyAgeM, absorb(Year ISOCode) cluster(OfficeCode)
...
binscatter lcfr shareHF, ///
    absorb(ISOCode) controls(i.Year TotWorkersWC TotWorkersBC MShare EarlyAgeM) ///
    mcolor(ebblue) lcolor(orange) ///
...
*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
*-? s-3-2. productivity against cumulative number of lateral moves (by destination manager type)
*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
...
graph export "${Results}/FactoryOutput_CumsumLateralMoves_toHTypeMngrs.png", replace as(png)
...
graph export "${Results}/FactoryCost_CumsumLateralMoves_toHTypeMngrs.png", replace as(png)
...
graph export "${Results}/FactoryOutput_CumsumLateralMoves_toLTypeMngrs.png", replace as(png)
...
graph export "${Results}/FactoryCost_CumsumLateralMoves_toLTypeMngrs.png", replace as(png)
