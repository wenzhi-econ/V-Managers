...
gen  ChangeMR = 0 
replace ChangeMR = 1 if ChangeM==1 & MaxWLM>1 & ( TransferSJF2==0 & TransferSJF1==0 & TransferSJ==0 & TransferSJL1==0   )  // manager internal rotation 
*replace ChangeMR = 1 if ChangeM==1 & MaxWLM>1 & ( TransferInternalF2M==1  | TransferInternalF1M==1 | TransferInternalM==1 | TransferInternalL1M==1  |  TransferInternalL2M==1 | TransferSJF2M==1 | TransferSJF1M==1 | TransferSJM==1 | TransferSJL1M==1 | TransferSJL2M==1   ) & ( TransferInternalF2==0  & TransferInternalF1==0 & TransferInternal==0 & TransferInternalL1==0   &  TransferInternalL2==0  & TransferSJF2==0 & TransferSJF1==0 & TransferSJ==0 & TransferSJL1==0 & TransferSJL2==0   )  // manager internal rotation 
