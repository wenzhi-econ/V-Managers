...
esttab using "$Results/3.2.ManagerReg/During`MQ'.tex",  stats(EmployeeFE r2 ymean N , fmt(%9.3f %9.3f %9.3f %9.0g) labels("Employee FE" "\midrule R-squared" "Mean" "Number of obs."))   drop(_cons ) se r2 nonotes star(* 0.10 ** 0.05 *** 0.01)   replace
}
...
esttab using "$Results/3.2.ManagerReg/During`MQ'Tr.tex",  stats(EmployeeFE r2 ymean N , fmt(%9.3f %9.3f %9.3f %9.0g) labels("Employee FE" "\midrule R-squared" "Mean" "Number of obs."))   drop(_cons ) se r2 nonotes star(* 0.10 ** 0.05 *** 0.01)   replace
...
esttab using "$Results/3.2.ManagerReg/During`MQ'byTr.tex",  prehead("\begin{tabular}{l*{2}{c}} \hline\hline") ///
...
estadd local EmployeeFE "No" , replace
 ...
 esttab using "$Results/3.2.ManagerReg/During`MQ'byTr.tex", posthead("\hline \\ \multicolumn{7}{c}{\textbf{Panel B: No job transfer}} \\\\[-1ex]") fragment  ///
...
esttab using "$Results/3.2.ManagerReg/1m`MQ'.tex",  stats(EmployeeFE r2 ymean N , fmt(%9.3f %9.3f %9.3f %9.0g) labels("Employee FE" "\midrule R-squared" "Mean" "Number of obs."))   drop(_cons ) se r2 nonotes star(* 0.10 ** 0.05 *** 0.01)   replace
}
...
esttab using "$Results/3.2.ManagerReg/1y`MQ'.tex",  stats(EmployeeFE r2 ymean N , fmt(%9.3f %9.3f %9.3f %9.0g) labels("Employee FE" "\midrule R-squared" "Mean" "Number of obs."))   drop(_cons ) se r2 nonotes star(* 0.10 ** 0.05 *** 0.01)   replace
}
...
esttab using "$Results/3.2.ManagerReg/1y`MQ'Tr.tex",  stats(EmployeeFE r2 ymean N , fmt(%9.3f %9.3f %9.3f %9.0g) labels("Employee FE" "\midrule R-squared" "Mean" "Number of obs."))   drop(_cons ) se r2 nonotes star(* 0.10 ** 0.05 *** 0.01)   replace
...
esttab using "$Results/3.2.ManagerReg/1y`MQ'byTr.tex",  prehead("\begin{tabular}{l*{2}{c}} \hline\hline") ///
posthead("\hline \\ \multicolumn{7}{c}{\textbf{Panel A: Job transfer}} \\\\[-1ex]") ///
fragment ///
...
estadd local EmployeeFE "No" , replace
 ...
 esttab using "$Results/3.2.ManagerReg/1y`MQ'byTr.tex", posthead("\hline \\ \multicolumn{7}{c}{\textbf{Panel B: No job transfer}} \\\\[-1ex]") fragment  ///
nomtitles nonumbers nolines prefoot("\hline") postfoot("\hline\hline \end{tabular}") /// 
stats(EmployeeFE r2 ymean N , fmt(%9.3f %9.3f %9.3f %9.0g) labels("Employee FE" "\midrule R-squared" "Mean" "Number of obs."))   drop(_cons ) se r2 nonotes star(* 0.10 ** 0.05 *** 0.01)  append
}
...
esttab using "$Results/3.2.ManagerReg/2y`MQ'.tex",  stats(EmployeeFE r2 ymean N , fmt(%9.3f %9.3f %9.3f %9.0g) labels("Employee FE" "\midrule R-squared" "Mean" "Number of obs."))   drop(_cons ) se r2 nonotes star(* 0.10 ** 0.05 *** 0.01)   replace
}
