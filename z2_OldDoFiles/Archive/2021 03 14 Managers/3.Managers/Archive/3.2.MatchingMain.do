...
esttab using "$Full/Results/3.2.ManagerReg/DuringTrWC.tex",  stats(EmployeeFE r2 ymean N , fmt(%9.3f %9.3f %9.3f %9.0g) labels("Employee FE" "\midrule R-squared" "Mean" "Number of obs."))  nomtitles mgroups("Job change during spell", pattern(1 0 0 0 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span}))  drop(_cons ) se r2 nonotes star(* 0.10 ** 0.05 *** 0.01)   replace
...
esttab using "$Full/Results/3.2.ManagerReg/Post1yE`MQ'WC.tex",  stats(EmployeeFE r2 ymean N , fmt(%9.3f %9.3f %9.3f %9.0g) labels("Employee FE" "\midrule R-squared" "Mean" "Number of obs.")) nomtitles mgroups("PR" "Promotion"  "Bonus (logs)" "Exit" , pattern( 1 0 1 0 1 0 1 0 ) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span}))   drop(_cons ) se r2 nonotes star(* 0.10 ** 0.05 *** 0.01)   replace
}
...
esttab using "$Full/Results/3.2.ManagerReg/Post1yE`MQ'byTrWC.tex", stats(JobTransfer r2 ymean N , fmt(%9.3f %9.3f %9.3f %9.0g) labels("Job Change" "\midrule R-squared" "Mean" "Number of obs.")) nomtitles mgroups("PRI" "Promotion"  "Bonus (logs)" "Exit", pattern( 1  0 1  0 1  0 1  0 ) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span}))   drop(_cons ) se r2 nonotes star(* 0.10 ** 0.05 *** 0.01)   replace
...
esttab using "$Full/Results/3.2.ManagerReg/Post1yE`MQ'BC.tex",  stats(EmployeeFE r2 ymean N , fmt(%9.3f %9.3f %9.3f %9.0g) labels("Employee FE" "\midrule R-squared" "Mean" "Number of obs.")) nomtitles mgroups("PR" "Promotion"  "Bonus (logs)" "Exit" , pattern( 1 0 1 0 1 0 1 0 ) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span}))   drop(_cons ) se r2 nonotes star(* 0.10 ** 0.05 *** 0.01)   replace
}
...
esttab using "$Full/Results/3.2.ManagerReg/Post1yE`MQ'byTrBC.tex", stats(JobTransfer r2 ymean N , fmt(%9.3f %9.3f %9.3f %9.0g) labels("Job Change" "\midrule R-squared" "Mean" "Number of obs.")) nomtitles mgroups("PRI" "Promotion"  "Bonus (logs)" "Exit", pattern( 1  0 1  0 1  0 1  0 ) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span}))   drop(_cons ) se r2 nonotes star(* 0.10 ** 0.05 *** 0.01)   replace
