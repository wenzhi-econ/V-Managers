...
local prepost LogPayBonus Pay Bonus PR PRI PRSnapshot VPA TimetoProm TimetoChangeSG PromSalaryGrade PromSalaryGradeC ChangeSalaryGrade ChangeSalaryGradeC MonthsPromSGCum MonthsSGCum  TransferSubFunc  TransferSubFuncC TransferFunc TransferFuncC TransferPTitle TransferPTitleC MonthsSubFunc MonthsWL TransferCountry TransferCountryC TransferSJ TransferSJC 
...
label var  `var'PostS`i'yM  "`var' `i' year(s) post spell" 
 ...
 local MSpell LogPayBonusPostS*yM  LogPayBonusPreS*yM  PayPostS*yM PayPreS*yM  BonusPostS*yM  BonusPreS*yM PRPostS*yM  PRPreS*yM PRIPostS*yM  PRIPreS*yM  PRSnapshotPostS*yM  PRSnapshotPreS*yM   VPAPostS*yM  VPAPreS*yM  PromSalaryGradePostS*yM  PromSalaryGradePreS*yM  PromSalaryGradeCPostS*yM  PromSalaryGradeCPreS*yM    ChangeSalaryGradeCPostS*yM  ChangeSalaryGradeCPreS*yM  ChangeSalaryGradePostS*yM  ChangeSalaryGradePreS*yM  MonthsPromSGCumPostS*yM  MonthsPromSGCumPreS*yM  MonthsSGCumPostS*yM  MonthsSGCumPreS*yM   TransferSubFuncCPostS*yM  TransferSubFuncCPreS*yM   TransferSubFuncPostS*  TransferSubFuncPreS*yM  TransferFuncCPostS*yM  TransferFuncCPreS*yM  TransferFuncPostS*yM  TransferFuncPreS*yM   TransferPTitleCPostS*yM  TransferPTitleCPreS*yM TransferPTitlePostS*yM  TransferPTitlePreS*yM  MonthsSubFuncPostS*yM  MonthsSubFuncPreS*yM   MonthsWLPostS*yM  MonthsWLPreS*yM   TransferCountryPostS*yM  TransferCountryPreS*yM  TransferCountryCPostS*yM  TransferCountryCPreS*yM  TimetoPromPostS*yM  TimetoPromPreS*yM  TimetoChangeSGPostS*yM  TimetoChangeSGPreS*yM   LeaverInvPostS*yM  LeaverVolPostS*yM   LeaverPermPostS*yM  TransferSJPreS*yM TransferSJCPreS*yM TransferSJPostS*yM TransferSJCPostS*yM LogPayBonusStartSM PayStartSM BonusStartSM PRStartSM PRIStartSM PRSnapshotStartSM VPAStartSM TimetoPromStartSM TimetoChangeSGStartSM PromSalaryGradeStartSM PromSalaryGradeCStartSM ChangeSalaryGradeCStartSM ChangeSalaryGradeStartSM MonthsPromSGCumStartSM MonthsSGCumStartSM TransferSubFuncStartSM TransferSubFuncCStartSM TransferFuncStartSM TransferFuncCStartSM TransferPTitleCStartSM   TransferPTitleStartSM  MonthsSubFuncStartSM   MonthsWLStartSM TransferCountryStartSM  TransferCountryCStartSM  TransferSJCStartSM TransferSJStartSM 
...
label var  `var'PostS`i'y  "`var' `i' year(s) post spell" 
 ...
 local ESpell LogPayBonusPostS*y LogPayBonusPreS*y PayPostS*y  PayPreS*y  BonusPostS*y  BonusPreS*y   PRPreS*y   PRIPostS*y  PRIPreS*y   PRSnapshotPostS*y  PRSnapshotPreS*y  VPAPostS*y  VPAPreS*y  PromSalaryGradeCPostS*y  PromSalaryGradeCPreS*y PromSalaryGradePostS*y  PromSalaryGradePreS*y ChangeSalaryGradePostS*y  ChangeSalaryGradePreS*y  ChangeSalaryGradeCPostS*y  ChangeSalaryGradeCPreS*y  MonthsPromSGCumPostS*y MonthsPromSGCumPreS*y  MonthsSGCumPostS*y  MonthsSGCumPreS*y TransferSubFuncPostS*y  TransferSubFuncPreS*y  TransferSubFuncCPostS*y  TransferSubFuncCPreS*y   TransferFuncPostS*y  TransferFuncPreS*y  TransferFuncCPostS*y  TransferFuncCPreS*y   TransferPTitleCPostS*y TransferPTitleCPreS*y TransferPTitlePostS*y TransferPTitlePreS*y  MonthsSubFuncPostS*y MonthsSubFuncPreS*y  MonthsWLPostS*y MonthsWLPreS*y TransferSJCPreS*y TransferSJPreS*y  TransferSJCPostS*y TransferSJPostS*y  TransferCountryPostS*y  TransferCountryPreS*y TransferCountryCPostS*y  TransferCountryCPreS*y  TimetoPromPostS*y  TimetoPromPreS*y  TimetoChangeSGPostS*y  TimetoChangeSGPreS*y  LeaverInvPostS*y LeaverVolPostS*y   LeaverPermPostS*y LogPayBonusStartS PayStartS BonusStartS PRStartS PRIStartS PRSnapshotStartS VPAStartS TimetoPromStartS TimetoChangeSGStartS PromSalaryGradeCStartS ChangeSalaryGradeCStartS MonthsPromSGCumStartS MonthsSGCumStartS TransferSubFuncCStartS TransferFuncCStartS TransferPTitleCStartS MonthsSubFuncStartS   MonthsWLStartS TransferCountryCStartS TransferSJCStartS TransferSJStartS 
