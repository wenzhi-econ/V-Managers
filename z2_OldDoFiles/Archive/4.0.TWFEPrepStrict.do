...
gen  ChangeMR = 0 
replace ChangeMR = 1 if ChangeM==1 & (TransferInternalM==1) // manager internal rotation 
replace ChangeMR = 0 if  TransferInternal==1 // no employee rotation 
...
keep if Ei!=. //   3,481,922 / 8618267 = 40% of obs 
distinct IDlse //  50913. So 50913/   205432 = 25% experience this event 
...
compress 
save "$Managersdta/SwitchersStrict.dta", replace 
