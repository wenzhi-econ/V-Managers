...
path_output_data = "E:/__RA/02MANAGERS/Paper Managers/Data/02TempData/temp_SkillsAfterLDA_NoM.dta"
...
skills_combined["Skills_Without_Management"] = skills_combined[
    "Skills"
].str.replace("management", "", case=False)
...
skills_matrix = vectorizer.fit_transform(
    skills_combined["Skills_Without_Management"]
)
...
def fit_lda_and_get_topics(n_topics, skills_matrix):
    ...
    for i in range(n_topics):
        skills_combined[f"Topic{i+1}_{n_topics}_NoM"] = topic_distributions[
            :, i
        ]
...
generate_word_clouds(top_words_3_topics_50, path_output_fig, "LDA3_50Words_NoM")
generate_word_clouds(
    top_words_3_topics_1000, path_output_fig, "LDA3_1000Words_NoM"
)
