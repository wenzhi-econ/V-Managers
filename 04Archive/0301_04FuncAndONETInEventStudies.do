/* 
This do file runs event study regressions on the combination of cross-functional transfers and ONET task moves.
...
Output:
    "${Results}/logfile_20250114_ONETOutcomesInEventStudies.txt"
    "${Results}/FT_TFuncONETC.dta"
...
capture log close
log using "${Results}/logfile_20250114_ONETOutcomesInEventStudies", replace text
...
save "${Results}/FT_TFuncONETC.dta", replace 
