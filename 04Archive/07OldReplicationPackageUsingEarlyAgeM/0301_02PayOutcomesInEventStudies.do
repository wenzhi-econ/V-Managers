/* 
This do file runs event study regressions on three pay-relevant outcomes:
...
Output:
    "${Results}/logfile_20241119_PayOutcomesInEventStudies.txt"
    "${Results}/FT_PayOutcomes.dta"
...
capture log close
log using "${Results}/logfile_20241119_PayOutcomesInEventStudies", replace text
...
save "${Results}/FT_PayOutcomes.dta", replace 
