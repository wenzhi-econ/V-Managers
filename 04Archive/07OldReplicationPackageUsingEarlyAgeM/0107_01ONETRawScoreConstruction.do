...
Output:
    "${TempData}/0701ONET_RawTaskIntensity.dta" <== main output, will be used in 0107_02 
...
save "${TempData}/0701ONET_RawTaskIntensity.dta", replace

*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
*-? s-5-4. remove auxiliary datasets
*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?

if $if_erase_temp_file==1 {
    erase "${TempData}/temp_ONET_Abilities.dta"
    erase "${TempData}/temp_ONET_Skills.dta"
    erase "${TempData}/temp_ONET_Knowledge.dta"
    erase "${TempData}/temp_ONET_WorkContext.dta"
    erase "${TempData}/temp_ONET_SJCrosswalk.dta"
}