...
Output:
    "${Results}/logfile_20241206_TwoMainOutcomes_Robustness_Poisson.txt"
...
capture log close
log using "${Results}/logfile_20241206_TwoMainOutcomes_Robustness_Poisson", replace text
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    if "`var'" == "TransferSJVC"       global ylabelsetup -0.9(0.1)0.5
    ...
    *-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
    ...
    ppmlhdfe `var' ${four_events_dummies} if (FT_Mngr_both_WL2==1 & FT_Never_ChangeM==0), absorb(IDlse YearMonth) vce(cluster IDlseMHR) 
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/FT_Gains_AllEstimates_`var'_Poisson.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/FT_Loss_AllEstimates_`var'_Poisson.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/FT_GainsMinusLoss_AllEstimates_`var'_Poisson.gph", replace
...
save "${Results}/FT_TwoMainOutcomes_Poisson.dta", replace 
