...
Output:
    "${Results}/logfile_20241119_TwoMainOutcomesInEventStudies.txt"
...
capture log close
log using "${Results}/logfile_20241119_TwoMainOutcomesInEventStudies", replace text
...
save "${Results}/FT_TwoMainOutcomes.dta", replace 
