...
capture log close
log using "${Results}/logfile_20241010_MainOutcomes_WithoutControlWorkers_HF2M", replace text
...
*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
*-? s-0-1. event * period dummies based on HF2 
*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
...
*!! HF2_LtoL
generate byte HF2_LtoL_X_Pre_Before`max_pre_period' = HF2_LtoL * (HF2_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte HF2_LtoL_X_Pre`time' = HF2_LtoL * (HF2_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte HF2_LtoL_X_Post`time' = HF2_LtoL * (HF2_Rel_Time == `time')
}
generate byte HF2_LtoL_X_Post_After`Lto_max_post_period' = HF2_LtoL * (HF2_Rel_Time > `Lto_max_post_period')

*!! HF2_LtoH
generate byte HF2_LtoH_X_Pre_Before`max_pre_period' = HF2_LtoH * (HF2_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte HF2_LtoH_X_Pre`time' = HF2_LtoH * (HF2_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte HF2_LtoH_X_Post`time' = HF2_LtoH * (HF2_Rel_Time == `time')
}
generate byte HF2_LtoH_X_Post_After`Lto_max_post_period' = HF2_LtoH * (HF2_Rel_Time > `Lto_max_post_period')

*!! HF2_HtoH 
generate byte HF2_HtoH_X_Pre_Before`max_pre_period' = HF2_HtoH * (HF2_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte HF2_HtoH_X_Pre`time' = HF2_HtoH * (HF2_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte HF2_HtoH_X_Post`time' = HF2_HtoH * (HF2_Rel_Time == `time')
}
generate byte HF2_HtoH_X_Post_After`Hto_max_post_period' = HF2_HtoH * (HF2_Rel_Time > `Hto_max_post_period')

*!! HF2_HtoL 
generate byte HF2_HtoL_X_Pre_Before`max_pre_period' = HF2_HtoL * (HF2_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte HF2_HtoL_X_Pre`time' = HF2_HtoL * (HF2_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte HF2_HtoL_X_Post`time' = HF2_HtoL * (HF2_Rel_Time == `time')
}
generate byte HF2_HtoL_X_Post_After`Hto_max_post_period' = HF2_HtoL * (HF2_Rel_Time > `Hto_max_post_period')

*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
*-? step 4. global macros used in regressions 
*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
...
global four_events_dummies ${HF2_LtoL_X_Pre} ${HF2_LtoL_X_Post} ${HF2_LtoH_X_Pre} ${HF2_LtoH_X_Post} ${HF2_HtoH_X_Pre} ${HF2_HtoH_X_Post} ${HF2_HtoL_X_Pre} ${HF2_HtoL_X_Post}
...
display "${four_events_dummies}"
    ...
    // HF2_HtoH_X_Pre_Before36 HF2_HtoH_X_Pre36 ... HF2_HtoH_X_Pre4 HF2_HtoH_X_Post0 HF2_HtoH_X_Post1 ... HF2_HtoH_X_Post60 HF2_HtoH_X_Pre_After60 
    // HF2_HtoL_X_Pre_Before36 HF2_HtoL_X_Pre36 ... HF2_HtoL_X_Pre4 HF2_HtoL_X_Post0 HF2_HtoL_X_Post1 ... HF2_HtoL_X_Post60 HF2_HtoL_X_Pre_After60 
...
foreach var in TransferSJVC TransferFuncC ChangeSalaryGradeC {
    ...
    *-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
    ...
    reghdfe `var' ${four_events_dummies} if (HF2_Mngr_both_WL2==1 & HF2_Never_ChangeM==0), absorb(IDlse YearMonth) vce(cluster IDlseMHR) 
    ...
    *!! quarterly estimates
    LH_minus_LL, event_prefix(HF2) pre_window_len(36) post_window_len(84) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/WithoutControlWorkers_HF2_Gains_AllEstimates_`var'.gph", replace
    ...
    *!! quarterly estimates
    HL_minus_HH, event_prefix(HF2) pre_window_len(36) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/WithoutControlWorkers_HF2_Loss_AllEstimates_`var'.gph", replace   
    ...
    *!! post-event joint p-value
    postevent_Double_Diff, event_prefix(HF2) post_window_len(60)
        global postevent_`var' = r(postevent)
        global postevent_`var' = string(${postevent_`var'}, "%4.3f")
        generate postevent_`var' = ${postevent_`var'}

    *!! quarterly estimates
    Double_Diff, event_prefix(HF2) pre_window_len(36) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/WithoutControlWorkers_HF2_GainsMinusLoss_AllEstimates_`var'.gph", replace
...
foreach var in LogPayBonus LogPay LogBonus {
    ...
    *&& Quarter 28 estimate is the average of Month 82, Month 83, and Month 84 estimates
    ...
    xlincom ///
        (((HF2_LtoH_X_Post34 - HF2_LtoL_X_Post34) + (HF2_LtoH_X_Post35 - HF2_LtoL_X_Post35) + (HF2_LtoH_X_Post36 - HF2_LtoL_X_Post36))/3) ///
        (((HF2_LtoH_X_Post58 - HF2_LtoL_X_Post58) + (HF2_LtoH_X_Post59 - HF2_LtoL_X_Post59) + (HF2_LtoH_X_Post60 - HF2_LtoL_X_Post60))/3) ///
        (((HF2_LtoH_X_Post82 - HF2_LtoL_X_Post82) + (HF2_LtoH_X_Post83 - HF2_LtoL_X_Post83) + (HF2_LtoH_X_Post84 - HF2_LtoL_X_Post84))/3) ///
        , level(95) post
    ...
    graph save "${Results}/WithoutControlWorkers_HF2_Gains_ThreeQuarterEstimates_`var'.gph", replace
}

keep PTGain_* coeff_* quarter_* lb_* ub_* PTLoss_* PTDiff_* postevent_* 

save "${Results}/WithoutControlWorkers_HF2_MainResults.dta", replace 
