...
capture log close
log using "${Results}/logfile_20241008_MainOutcomes_WithoutControlWorkers_HF2S", replace text
...
*-?*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??
*-? s-0-1. event * period dummies based on HF2S 
*-?*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??*??

summarize HF2S_Rel_Time, detail // range: [-113, +130]
...
*!! HF2S_LtoL
generate byte HF2S_LtoL_X_Pre_Before`max_pre_period' = HF2S_LtoL * (HF2S_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte HF2S_LtoL_X_Pre`time' = HF2S_LtoL * (HF2S_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte HF2S_LtoL_X_Post`time' = HF2S_LtoL * (HF2S_Rel_Time == `time')
}
generate byte HF2S_LtoL_X_Post_After`Lto_max_post_period' = HF2S_LtoL * (HF2S_Rel_Time > `Lto_max_post_period')

*!! HF2S_LtoH
generate byte HF2S_LtoH_X_Pre_Before`max_pre_period' = HF2S_LtoH * (HF2S_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte HF2S_LtoH_X_Pre`time' = HF2S_LtoH * (HF2S_Rel_Time == -`time')
}
forvalues time = 0/`Lto_max_post_period' {
    generate byte HF2S_LtoH_X_Post`time' = HF2S_LtoH * (HF2S_Rel_Time == `time')
}
generate byte HF2S_LtoH_X_Post_After`Lto_max_post_period' = HF2S_LtoH * (HF2S_Rel_Time > `Lto_max_post_period')

*!! HF2S_HtoH 
generate byte HF2S_HtoH_X_Pre_Before`max_pre_period' = HF2S_HtoH * (HF2S_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte HF2S_HtoH_X_Pre`time' = HF2S_HtoH * (HF2S_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte HF2S_HtoH_X_Post`time' = HF2S_HtoH * (HF2S_Rel_Time == `time')
}
generate byte HF2S_HtoH_X_Post_After`Hto_max_post_period' = HF2S_HtoH * (HF2S_Rel_Time > `Hto_max_post_period')

*!! HF2S_HtoL 
generate byte HF2S_HtoL_X_Pre_Before`max_pre_period' = HF2S_HtoL * (HF2S_Rel_Time < -`max_pre_period')
forvalues time = 1/`max_pre_period' {
    generate byte HF2S_HtoL_X_Pre`time' = HF2S_HtoL * (HF2S_Rel_Time == -`time')
}
forvalues time = 0/`Hto_max_post_period' {
    generate byte HF2S_HtoL_X_Post`time' = HF2S_HtoL * (HF2S_Rel_Time == `time')
}
generate byte HF2S_HtoL_X_Post_After`Hto_max_post_period' = HF2S_HtoL * (HF2S_Rel_Time > `Hto_max_post_period')
...
foreach event in HF2S_LtoL HF2S_LtoH {
...
foreach event in HF2S_HtoH HF2S_HtoL {
    global `event'_X_Pre `event'_X_Pre_Before`max_pre_period'
    forvalues time = `max_pre_period'(-1)4 {
        global `event'_X_Pre ${`event'_X_Pre} `event'_X_Pre`time'
    }
...
global four_events_dummies ${HF2S_LtoL_X_Pre} ${HF2S_LtoL_X_Post} ${HF2S_LtoH_X_Pre} ${HF2S_LtoH_X_Post} ${HF2S_HtoH_X_Pre} ${HF2S_HtoH_X_Post} ${HF2S_HtoL_X_Pre} ${HF2S_HtoL_X_Post}

display "${four_events_dummies}"

    // HF2S_LtoL_X_Pre_Before36 HF2S_LtoL_X_Pre36 ... HF2S_LtoL_X_Pre4 HF2S_LtoL_X_Post0 HF2S_LtoL_X_Post1 ... HF2S_LtoL_X_Post84 HF2S_LtoL_X_Pre_After84 
    // HF2S_LtoH_X_Pre_Before36 HF2S_LtoH_X_Pre36 ... HF2S_LtoH_X_Pre4 HF2S_LtoH_X_Post0 HF2S_LtoH_X_Post1 ... HF2S_LtoH_X_Post84 HF2S_LtoH_X_Pre_After84 
    // HF2S_HtoH_X_Pre_Before36 HF2S_HtoH_X_Pre36 ... HF2S_HtoH_X_Pre4 HF2S_HtoH_X_Post0 HF2S_HtoH_X_Post1 ... HF2S_HtoH_X_Post60 HF2S_HtoH_X_Pre_After60 
    // HF2S_HtoL_X_Pre_Before36 HF2S_HtoL_X_Pre36 ... HF2S_HtoL_X_Pre4 HF2S_HtoL_X_Post0 HF2S_HtoL_X_Post1 ... HF2S_HtoL_X_Post60 HF2S_HtoL_X_Pre_After60 
...
foreach var in TransferSJVC TransferFuncC ChangeSalaryGradeC {
    ...
    *-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
    ...
    reghdfe `var' ${four_events_dummies} if (HF2S_Mngr_both_WL2==1 & HF2S_Never_ChangeM==0), absorb(IDlse YearMonth) vce(cluster IDlseMHR) 
    ...
    *!! pre-event joint p-value
    pretrend_LH_minus_LL, event_prefix(HF2S) pre_window_len(36)
        global PTGain_`var' = r(pretrend)
        global PTGain_`var' = string(${PTGain_`var'}, "%4.3f")
        generate PTGain_`var' = ${PTGain_`var'}

    *!! quarterly estimates
    LH_minus_LL, event_prefix(HF2S) pre_window_len(36) post_window_len(84) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/WithoutControlWorkers_HF2S_Gains_AllEstimates_`var'.gph", replace
    ...
    *!! pre-event joint p-value
    pretrend_HL_minus_HH, event_prefix(HF2S) pre_window_len(36)
        global PTLoss_`var' = r(pretrend)
        global PTLoss_`var' = string(${PTLoss_`var'}, "%4.3f")
        generate PTLoss_`var' = ${PTLoss_`var'}

    *!! quarterly estimates
    HL_minus_HH, event_prefix(HF2S) pre_window_len(36) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/WithoutControlWorkers_HF2S_Loss_AllEstimates_`var'.gph", replace   
    ...
    *!! pre-event joint p-value
    pretrend_Double_Diff, event_prefix(HF2S) pre_window_len(36)
    ...
    *!! post-event joint p-value
    postevent_Double_Diff, event_prefix(HF2S) post_window_len(60)
        global postevent_`var' = r(postevent)
        global postevent_`var' = string(${postevent_`var'}, "%4.3f")
        generate postevent_`var' = ${postevent_`var'}

    *!! quarterly estimates
    Double_Diff, event_prefix(HF2S) pre_window_len(36) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/WithoutControlWorkers_HF2S_GainsMinusLoss_AllEstimates_`var'.gph", replace
...
foreach var in LogPayBonus LogPay LogBonus {
    ...
    *&& Quarter 28 estimate is the average of Month 82, Month 83, and Month 84 estimates
    ...
    xlincom ///
        (((HF2S_LtoH_X_Post34 - HF2S_LtoL_X_Post34) + (HF2S_LtoH_X_Post35 - HF2S_LtoL_X_Post35) + (HF2S_LtoH_X_Post36 - HF2S_LtoL_X_Post36))/3) ///
        (((HF2S_LtoH_X_Post58 - HF2S_LtoL_X_Post58) + (HF2S_LtoH_X_Post59 - HF2S_LtoL_X_Post59) + (HF2S_LtoH_X_Post60 - HF2S_LtoL_X_Post60))/3) ///
        (((HF2S_LtoH_X_Post82 - HF2S_LtoL_X_Post82) + (HF2S_LtoH_X_Post83 - HF2S_LtoL_X_Post83) + (HF2S_LtoH_X_Post84 - HF2S_LtoL_X_Post84))/3) ///
        , level(95) post
    ...
    graph save "${Results}/WithoutControlWorkers_HF2S_Gains_ThreeQuarterEstimates_`var'.gph", replace
}

keep PTGain_* coeff_* quarter_* lb_* ub_* PTLoss_* PTDiff_* postevent_* 

save "${Results}/WithoutControlWorkers_HF2S_MainResults.dta", replace 
