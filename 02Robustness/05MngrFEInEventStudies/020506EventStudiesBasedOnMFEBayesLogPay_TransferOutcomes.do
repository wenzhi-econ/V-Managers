...
merge m:1 IDlseMHR using "${TempData}/temp_MngrID_MFEBayesLogPay.dta", keep(match master) nogenerate
...
foreach var in TransferSJVC TransferFuncC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/WithoutControlWorkers_MFEBayesLogPay_Med_Gains_AllEstimates_`var'.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/WithoutControlWorkers_MFEBayesLogPay_Med_Loss_AllEstimates_`var'.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/WithoutControlWorkers_MFEBayesLogPay_Med_GainsMinusLoss_AllEstimates_`var'.gph", replace
...
foreach var in TransferSJVC TransferFuncC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    ...
    twoway ///
        ...
        xtitle(Quarters since manager change) title("${title}", span pos(12)) ///
        legend(off) note(Pre-trends joint p-value = ${PTGain_`var'})
    graph save "${Results}/WithoutControlWorkers_MFEBayesLogPay_p75_Gains_AllEstimates_`var'.gph", replace
    ...
    *!! quarterly estimates
    ...
    twoway ///
        ...
        xtitle(Quarters since manager change) title("${title}", span pos(12)) ///
        legend(off) note(Pre-trends joint p-value = ${PTLoss_`var'})
    graph save "${Results}/WithoutControlWorkers_MFEBayesLogPay_p75_Loss_AllEstimates_`var'.gph", replace   
    ...
    *!! quarterly estimates
    ...
    twoway ///
        ...
        xtitle(Quarters since manager change) title("${title}", span pos(12)) ///
        legend(off) note("Pre-trends joint p-value = ${PTDiff_`var'}" "Post coeffs. joint p-value = ${postevent_`var'}")
    graph save "${Results}/WithoutControlWorkers_MFEBayesLogPay_p75_GainsMinusLoss_AllEstimates_`var'.gph", replace
