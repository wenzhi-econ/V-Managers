...
capture log close
log using "${Results}/logfile_20241206_TwoMainOutcomes_Robustness_SingleCohort_EventWindow", replace text
...
For binned dummies, e.g. FT_LtoL_X_Pre_Before24 FT_LtoH_X_Post_After84
*/
...
display "${four_events_dummies}"
    ...
    // FT_LtoL_X_Pre_Before24 FT_LtoL_X_Pre24 ... FT_LtoL_X_Pre4 FT_LtoL_X_Post0 FT_LtoL_X_Post1 ... FT_LtoL_X_Post84 FT_LtoL_X_Pre_After84 
    // FT_LtoH_X_Pre_Before24 FT_LtoH_X_Pre24 ... FT_LtoH_X_Pre4 FT_LtoH_X_Post0 FT_LtoH_X_Post1 ... FT_LtoH_X_Post84 FT_LtoH_X_Pre_After84 
...
foreach var in TransferSJVC ChangeSalaryGradeC {
    ...
    *!! quarterly estimates
    LH_minus_LL, event_prefix(FT) pre_window_len(24) post_window_len(84) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/FT_Gains_AllEstimates_`var'_SingleCohort_EventWindow.gph", replace
    ...
    *!! quarterly estimates
    HL_minus_HH, event_prefix(FT) pre_window_len(24) post_window_len(60) outcome(`var')
    twoway ///
    ...
    graph save "${Results}/FT_Loss_AllEstimates_`var'_SingleCohort_EventWindow.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/FT_GainsMinusLoss_AllEstimates_`var'_SingleCohort_EventWindow.gph", replace
...
save "${Results}/FT_TwoMainOutcomes_SingleCohort_EventWindow.dta", replace 
