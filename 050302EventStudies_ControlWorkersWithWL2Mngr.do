...
capture log close
log using "${Results}/logfile_20240920_MainOutcomes_ControlWorkersWithWL2Mngr", replace text
...
foreach var in TransferSJVC TransferFuncC PromWLC ChangeSalaryGradeC {
    ...
    *-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
    reghdfe `var' ${four_events_dummies} ///
        if ((FT_Mngr_both_WL2==1 & FT_Never_ChangeM==0) | (FT_Never_ChangeM==1 & FT_Mngr_First_WL2==1)) ///
        , absorb(IDlse YearMonth)  vce(cluster IDlseMHR) 

        //&& Notice that I restrict the control sample to those whose first manager is WL2.
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/ControlWorkersWithWL2Mngr_FT_Gains_AllEstimates_`var'.gph", replace
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/ControlWorkersWithWL2Mngr_FT_Loss_AllEstimates_`var'.gph", replace   
    ...
    *!! quarterly estimates
    ...
    graph save "${Results}/ControlWorkersWithWL2Mngr_FT_GainsMinusLoss_AllEstimates_`var'.gph", replace
    ...
    *-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?*-?
    ...
    if "`var'" == "PromWLC" {
        ...
        *&& Quarter 28 estimate is the average of Month 82, Month 83, and Month 84 estimates
        ...
        graph save "${Results}/ControlWorkersWithWL2Mngr_FT_Gains_ThreeQuarterEstimates_`var'.gph", replace
    }     
